...
func GetManagedSeed(ctx context.Context, seedManagementClient versioned.Interface, shootNamespace, shootName string) (*v1alpha1.ManagedSeed, error) {
	managedSeedList, err := seedManagementClient.SeedmanagementV1alpha1().ManagedSeeds(shootNamespace).List(ctx, v1.ListOptions{
