...
func add(mgr manager.Manager, args AddArgs) error {
	...
	return ctrl.Watch(
		...
		mapper.EnqueueRequestsFrom(mapper.ClusterToObjectMapper(args.GetExtensionObjListFunc, predicates), mapper.UpdateWithNew, mgr.GetLogger().WithName(ControllerName)),
	)
}
