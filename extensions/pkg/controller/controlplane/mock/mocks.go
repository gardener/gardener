...
//
//	mockgen -destination=mocks.go -package=mock github.com/gardener/gardener/extensions/pkg/controller/controlplane Actuator
//
...
func (m *MockActuator) Delete(arg0 context.Context, arg1 logr.Logger, arg2 *v1alpha1.ControlPlane, arg3 *controller.Cluster) error {
	m.ctrl.T.Helper()
...
func (m *MockActuator) ForceDelete(arg0 context.Context, arg1 logr.Logger, arg2 *v1alpha1.ControlPlane, arg3 *controller.Cluster) error {
	m.ctrl.T.Helper()
...
func (m *MockActuator) Migrate(arg0 context.Context, arg1 logr.Logger, arg2 *v1alpha1.ControlPlane, arg3 *controller.Cluster) error {
	m.ctrl.T.Helper()
...
func (m *MockActuator) Reconcile(arg0 context.Context, arg1 logr.Logger, arg2 *v1alpha1.ControlPlane, arg3 *controller.Cluster) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockActuator) Restore(arg0 context.Context, arg1 logr.Logger, arg2 *v1alpha1.ControlPlane, arg3 *controller.Cluster) (bool, error) {
	m.ctrl.T.Helper()
