...
var _ = BeforeSuite(func() {
	...
	Expect(addShootReferenceControllerToManager(mgr)).To(Succeed())
...
func addShootReferenceControllerToManager(mgr manager.Manager) error {
	c, err := controller.New(
		"shoot-quota-controller",
		mgr,
		controller.Options{Reconciler: shootcontroller.NewShootReferenceReconciler(testClient)},
	)
	if err != nil {
		return err
	}
