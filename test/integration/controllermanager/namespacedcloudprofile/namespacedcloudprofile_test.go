				...
				MachineImages: []gardencorev1beta1.MachineImage{
					{
						...
						Versions: []gardencorev1beta1.MachineImageVersion{
							...
							{ExpirableVersion: gardencorev1beta1.ExpirableVersion{Version: "7.8.9"}, CRI: []gardencorev1beta1.CRI{{Name: "containerd"}}, Architectures: []string{"amd64"}, CapabilitySets: capabilitySets},
						},
					},
					{
						Name: "custom-image",
						Versions: []gardencorev1beta1.MachineImageVersion{
							{ExpirableVersion: gardencorev1beta1.ExpirableVersion{Version: "1.1.2"}, CRI: []gardencorev1beta1.CRI{{Name: "containerd"}}, Architectures: []string{"amd64"}, CapabilitySets: capabilitySets},
						},
