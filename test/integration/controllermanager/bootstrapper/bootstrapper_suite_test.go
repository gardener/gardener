...
func TestBootstrapper(t *testing.T) {
	...
	RunSpecs(t, "Test Integration ControllerManager Bootstrapper Suite")
}

// testID is used for generating test namespace names and other IDs
const testID = "bootstrapper-controller-test"
...
var _ = BeforeSuite(func() {
	...
	Expect(testClient.Create(ctx, &corev1.Namespace{ObjectMeta: metav1.ObjectMeta{Name: "garden"}})).To(Succeed())
