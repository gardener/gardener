...
var _ = Describe("Network Policy Testing", func() {
	...
	var (
		...
		CloudControllerManagerHttp10253 = &networkpolicies.TargetPod{
			...
			Port: networkpolicies.Port{
				Port: 10253,
				Name: ""}}
		CsiPluginController = &networkpolicies.SourcePod{
			Pod: networkpolicies.Pod{
			...
			ExpectedPolicies: sets.String{
				...
				"allow-to-shoot-apiserver": sets.Empty{},
				"deny-all":                 sets.Empty{}}}
		CsiPluginController80 = &networkpolicies.TargetPod{
			Pod: networkpolicies.Pod{
				Name: "csi-plugin-controller",
				Labels: labels.Set{
					"app":                     "kubernetes",
	...
	SynchronizedBeforeSuite(func() []byte {
		...
		cloudAwarePodInfo := networkpolicies.AlicloudNetworkPolicy{}
	...
	Context("egress for mirrored pods", func() {
		...
		Context("csi-plugin-controller", func() {
			...
			BeforeEach(func() {
				from = networkpolicies.NewNamespacedSourcePod(CsiPluginController, sharedResources.Mirror)
			})
