...
require (
	...
	github.com/VictoriaMetrics/operator/api v0.74.0
...
replace github.com/gardener/machine-controller-manager => github.com/acumino/machine-controller-manager v0.42.1-0.20260731085334-76d30d523730
