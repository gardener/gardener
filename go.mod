...
require (
	...
	k8s.io/cluster-bootstrap v0.29.7
...
replace github.com/gardener/machine-controller-manager v0.53.1 => github.com/oliver-goetz/machine-controller-manager v0.0.0-20240717084101-a907808aef33
