...
replace (
	...
	github.com/gardener/etcd-druid => github.com/vanjiii/etcd-druid v0.6.0-dev1
	github.com/gardener/etcd-druid/api => github.com/vanjiii/etcd-druid/api v0.6.0-dev1
