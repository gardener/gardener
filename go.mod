...
require (
	...
	github.com/gardener/etcd-druid v0.0.0-00010101000000-000000000000
...
replace (
	github.com/gardener/etcd-druid => github.com/gardener/etcd-druid v0.1.1-0.20200205100817-358bdea3145e
