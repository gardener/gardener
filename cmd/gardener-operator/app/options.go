...
import (
	...
	configv1alpha1 "github.com/gardener/gardener/pkg/operator/apis/config/v1alpha1"
	configvalidation "github.com/gardener/gardener/pkg/operator/apis/config/validation"
)
