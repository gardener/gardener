...
type DNSProviderInterface interface {
	Create(*v1alpha1.DNSProvider) (*v1alpha1.DNSProvider, error)
	Update(*v1alpha1.DNSProvider) (*v1alpha1.DNSProvider, error)
	UpdateStatus(*v1alpha1.DNSProvider) (*v1alpha1.DNSProvider, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.DNSProvider, error)
	List(opts v1.ListOptions) (*v1alpha1.DNSProviderList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DNSProvider, err error)
...
func (c *dNSProviders) Get(name string, options v1.GetOptions) (result *v1alpha1.DNSProvider, err error) {
...
func (c *dNSProviders) List(opts v1.ListOptions) (result *v1alpha1.DNSProviderList, err error) {
...
func (c *dNSProviders) Create(dNSProvider *v1alpha1.DNSProvider) (result *v1alpha1.DNSProvider, err error) {
	result = &v1alpha1.DNSProvider{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dnsproviders").
...
func (c *dNSProviders) Update(dNSProvider *v1alpha1.DNSProvider) (result *v1alpha1.DNSProvider, err error) {
	result = &v1alpha1.DNSProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnsproviders").
...
func (c *dNSProviders) UpdateStatus(dNSProvider *v1alpha1.DNSProvider) (result *v1alpha1.DNSProvider, err error) {
	result = &v1alpha1.DNSProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnsproviders").
...
func (c *dNSProviders) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DNSProvider, err error) {
	result = &v1alpha1.DNSProvider{}
