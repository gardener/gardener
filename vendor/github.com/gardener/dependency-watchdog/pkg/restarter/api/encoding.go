...
// Encode encodes the ServiceDependants objects into a string.
func Encode(dependants *ServiceDependants) (string, error) {
...
func Decode(data []byte) (*ServiceDependants, error) {
