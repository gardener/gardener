...
const (
	...
	// ImageNameGardenerCustomMetrics is a constant for an image in the image vector with name 'gardener-custom-metrics'.
	ImageNameGardenerCustomMetrics = "gardener-custom-metrics"
