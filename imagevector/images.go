...
const (
	...
	// ImageNameGardenerCustomMetics is a constant for an image in the image vector with name 'gardener-custom-metrics'.
	ImageNameGardenerCustomMetics = "gardener-custom-metrics"
