...
kind-extensions-up kind-extensions-down gardener-extensions-up gardener-extensions-down extensions-up extensions-down: export KUBECONFIG = $(GARDENER_EXTENSIONS_KUBECONFIG)
...
extensions-up extensions-down: export SEED_KUBECONFIG = $(GARDENER_EXTENSIONS_SEED_KUBECONFIG)

extensions-up extensions-down: export SEED_HOST = $(shell kubectl get configmaps -n kube-system shoot-info --kubeconfig $(GARDENER_EXTENSIONS_SEED_KUBECONFIG) -o yaml | yq '.data.domain')
...
extensions-up: $(SKAFFOLD) $(HELM) $(KUBECTL)
...
extensions-down: $(SKAFFOLD) $(HELM) $(KUBECTL)
