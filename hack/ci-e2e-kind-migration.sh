...
trap "
  ...
  ( export KUBECONFIG=$KUBECONFIG_RUNTIME_CLUSTER; export cluster_name='virtual-garden'; export_resource_yamls_for seeds shoots bastions.operations.gardener.cloud etcds leases; export_events_for_shoots )
