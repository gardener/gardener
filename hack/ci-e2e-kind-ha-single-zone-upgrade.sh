...
trap "
  ( rm -rf $GARDENER_RELEASE_DOWNLOAD_PATH/gardener-releases; export_logs 'gardener-local-ha-single-zone';
...
make test-pre-upgrade-ha-single-zone GARDENER_PREVIOUS_RELEASE=$GARDENER_PREVIOUS_RELEASE GARDENER_NEXT_RELEASE=$GARDENER_NEXT_RELEASE
...
wait_until_seed_gets_upgraded "local-ha-single-zone"

echo "Running gardener post-upgrade tests"
make test-post-upgrade-ha-single-zone GARDENER_PREVIOUS_RELEASE=$GARDENER_PREVIOUS_RELEASE GARDENER_NEXT_RELEASE=$GARDENER_NEXT_RELEASE
