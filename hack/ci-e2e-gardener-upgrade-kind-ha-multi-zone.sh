...
trap "
  ( rm -rf $DOWNLOAD_PATH/gardener-upgrade; export_logs 'gardener-local-ha-multi-zone';
...
make test-gardener-pre-upgrade-ha-multi-zone GARDENER_PREVIOUS_RELEASE=$GARDENER_PREVIOUS_RELEASE GARDENER_NEXT_RELEASE=$GARDENER_NEXT_RELEASE

download_and_upgrade_gardener_next_release

echo "Running gardener post-upgrade tests"
make test-gardener-post-upgrade-ha-multi-zone GARDENER_PREVIOUS_RELEASE=$GARDENER_PREVIOUS_RELEASE GARDENER_NEXT_RELEASE=$GARDENER_NEXT_RELEASE
