...
func Allowed() authorizationv1beta1.SubjectAccessReviewStatus {
...
func Denied(reason string) authorizationv1beta1.SubjectAccessReviewStatus {
	return authorizationv1beta1.SubjectAccessReviewStatus{
		Allowed: false,
		Denied:  true,
		Reason:  reason,
...
func NoOpinion(reason string) authorizationv1beta1.SubjectAccessReviewStatus {
	return authorizationv1beta1.SubjectAccessReviewStatus{
		Allowed: false,
		Reason:  reason,
	}
...
func Errored(code int32, err error) authorizationv1beta1.SubjectAccessReviewStatus {
	return authorizationv1beta1.SubjectAccessReviewStatus{
