...
// AddToManager adds new controllerregistration controllers to the given manager.
func AddToManager(
	ctx context.Context,
	mgr manager.Manager,
	...
	if err := addControllerRegistrationSeedReconciler(ctx, mgr, config); err != nil {
		return fmt.Errorf("failed to add controllerregistration-seed controller: %w", err)
	}
