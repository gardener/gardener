...
func GetDeprecatedVersionNotExpired(version string, lastTransition *metav1.Time) gardencorev1beta1.ExpirableVersion {
	return GetDeprecatedVersion(version, lastTransition, dateInFuture)
}

// GetDeprecatedVersion is a helper to return a 'deprecated' version
func GetDeprecatedVersion(version string, lastTransition, expiration *metav1.Time) gardencorev1beta1.ExpirableVersion {
...
func GetVersionWithPreviewClassification(version string, lastTransition *metav1.Time) gardencorev1beta1.ExpirableVersion {
	return gardencorev1beta1.ExpirableVersion{
		Version:        version,
...
func GetVersionWithSupportedClassification(version string, lastTransition *metav1.Time) gardencorev1beta1.ExpirableVersion {
	return gardencorev1beta1.ExpirableVersion{
		Version:        version,
