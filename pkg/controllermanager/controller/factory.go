...
func (f *LegacyControllerFactory) Start(ctx context.Context) error {
	...
	go shootController.Run(ctx, *f.Config.Controllers.ShootQuota.ConcurrentSyncs, *f.Config.Controllers.ShootReference.ConcurrentSyncs, *f.Config.Controllers.ShootRetry.ConcurrentSyncs, *f.Config.Controllers.ShootStatusLabel.ConcurrentSyncs)
