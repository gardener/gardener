...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*SecretBindingProviderPopulatorControllerConfiguration)(nil), (*config.SecretBindingProviderPopulatorControllerConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_SecretBindingProviderPopulatorControllerConfiguration_To_config_SecretBindingProviderPopulatorControllerConfiguration(a.(*SecretBindingProviderPopulatorControllerConfiguration), b.(*config.SecretBindingProviderPopulatorControllerConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.SecretBindingProviderPopulatorControllerConfiguration)(nil), (*SecretBindingProviderPopulatorControllerConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_SecretBindingProviderPopulatorControllerConfiguration_To_v1alpha1_SecretBindingProviderPopulatorControllerConfiguration(a.(*config.SecretBindingProviderPopulatorControllerConfiguration), b.(*SecretBindingProviderPopulatorControllerConfiguration), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ControllerManagerControllerConfiguration_To_config_ControllerManagerControllerConfiguration(in *ControllerManagerControllerConfiguration, out *config.ControllerManagerControllerConfiguration, s conversion.Scope) error {
	...
	out.SecretBindingProviderPopulator = (*config.SecretBindingProviderPopulatorControllerConfiguration)(unsafe.Pointer(in.SecretBindingProviderPopulator))
...
func autoConvert_config_ControllerManagerControllerConfiguration_To_v1alpha1_ControllerManagerControllerConfiguration(in *config.ControllerManagerControllerConfiguration, out *ControllerManagerControllerConfiguration, s conversion.Scope) error {
	...
	out.SecretBindingProviderPopulator = (*SecretBindingProviderPopulatorControllerConfiguration)(unsafe.Pointer(in.SecretBindingProviderPopulator))
...
func autoConvert_v1alpha1_SecretBindingProviderPopulatorControllerConfiguration_To_config_SecretBindingProviderPopulatorControllerConfiguration(in *SecretBindingProviderPopulatorControllerConfiguration, out *config.SecretBindingProviderPopulatorControllerConfiguration, s conversion.Scope) error {
	out.ConcurrentSyncs = in.ConcurrentSyncs
	return nil
}

// Convert_v1alpha1_SecretBindingProviderPopulatorControllerConfiguration_To_config_SecretBindingProviderPopulatorControllerConfiguration is an autogenerated conversion function.
func Convert_v1alpha1_SecretBindingProviderPopulatorControllerConfiguration_To_config_SecretBindingProviderPopulatorControllerConfiguration(in *SecretBindingProviderPopulatorControllerConfiguration, out *config.SecretBindingProviderPopulatorControllerConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha1_SecretBindingProviderPopulatorControllerConfiguration_To_config_SecretBindingProviderPopulatorControllerConfiguration(in, out, s)
}

func autoConvert_config_SecretBindingProviderPopulatorControllerConfiguration_To_v1alpha1_SecretBindingProviderPopulatorControllerConfiguration(in *config.SecretBindingProviderPopulatorControllerConfiguration, out *SecretBindingProviderPopulatorControllerConfiguration, s conversion.Scope) error {
	out.ConcurrentSyncs = in.ConcurrentSyncs
	return nil
}

// Convert_config_SecretBindingProviderPopulatorControllerConfiguration_To_v1alpha1_SecretBindingProviderPopulatorControllerConfiguration is an autogenerated conversion function.
func Convert_config_SecretBindingProviderPopulatorControllerConfiguration_To_v1alpha1_SecretBindingProviderPopulatorControllerConfiguration(in *config.SecretBindingProviderPopulatorControllerConfiguration, out *SecretBindingProviderPopulatorControllerConfiguration, s conversion.Scope) error {
	return autoConvert_config_SecretBindingProviderPopulatorControllerConfiguration_To_v1alpha1_SecretBindingProviderPopulatorControllerConfiguration(in, out, s)
}
