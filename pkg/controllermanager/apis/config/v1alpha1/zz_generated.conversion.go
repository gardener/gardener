...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*KubernetesVersionManagement)(nil), (*config.KubernetesVersionManagement)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_KubernetesVersionManagement_To_config_KubernetesVersionManagement(a.(*KubernetesVersionManagement), b.(*config.KubernetesVersionManagement), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.KubernetesVersionManagement)(nil), (*KubernetesVersionManagement)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_KubernetesVersionManagement_To_v1alpha1_KubernetesVersionManagement(a.(*config.KubernetesVersionManagement), b.(*KubernetesVersionManagement), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*MachineImageVersionManagement)(nil), (*config.MachineImageVersionManagement)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_MachineImageVersionManagement_To_config_MachineImageVersionManagement(a.(*MachineImageVersionManagement), b.(*config.MachineImageVersionManagement), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.MachineImageVersionManagement)(nil), (*MachineImageVersionManagement)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_MachineImageVersionManagement_To_v1alpha1_MachineImageVersionManagement(a.(*config.MachineImageVersionManagement), b.(*MachineImageVersionManagement), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CloudProfileControllerConfiguration_To_config_CloudProfileControllerConfiguration(in *CloudProfileControllerConfiguration, out *config.CloudProfileControllerConfiguration, s conversion.Scope) error {
	...
	out.KubernetesVersionManagement = (*config.KubernetesVersionManagement)(unsafe.Pointer(in.KubernetesVersionManagement))
	out.MachineImageVersionManagement = (*config.MachineImageVersionManagement)(unsafe.Pointer(in.MachineImageVersionManagement))
	return nil
}
...
func autoConvert_config_CloudProfileControllerConfiguration_To_v1alpha1_CloudProfileControllerConfiguration(in *config.CloudProfileControllerConfiguration, out *CloudProfileControllerConfiguration, s conversion.Scope) error {
	out.ConcurrentSyncs = in.ConcurrentSyncs
	out.KubernetesVersionManagement = (*KubernetesVersionManagement)(unsafe.Pointer(in.KubernetesVersionManagement))
	out.MachineImageVersionManagement = (*MachineImageVersionManagement)(unsafe.Pointer(in.MachineImageVersionManagement))
	return nil
}
...
func autoConvert_v1alpha1_KubernetesVersionManagement_To_config_KubernetesVersionManagement(in *KubernetesVersionManagement, out *config.KubernetesVersionManagement, s conversion.Scope) error {
	out.Enabled = in.Enabled
	out.MaintainedKubernetesVersions = (*int)(unsafe.Pointer(in.MaintainedKubernetesVersions))
	out.ExpirationDurationMaintainedVersion = (*v1.Duration)(unsafe.Pointer(in.ExpirationDurationMaintainedVersion))
	out.ExpirationDurationUnmaintainedVersion = (*v1.Duration)(unsafe.Pointer(in.ExpirationDurationUnmaintainedVersion))
	return nil
}

// Convert_v1alpha1_KubernetesVersionManagement_To_config_KubernetesVersionManagement is an autogenerated conversion function.
func Convert_v1alpha1_KubernetesVersionManagement_To_config_KubernetesVersionManagement(in *KubernetesVersionManagement, out *config.KubernetesVersionManagement, s conversion.Scope) error {
	return autoConvert_v1alpha1_KubernetesVersionManagement_To_config_KubernetesVersionManagement(in, out, s)
}

func autoConvert_config_KubernetesVersionManagement_To_v1alpha1_KubernetesVersionManagement(in *config.KubernetesVersionManagement, out *KubernetesVersionManagement, s conversion.Scope) error {
	out.Enabled = in.Enabled
	out.MaintainedKubernetesVersions = (*int)(unsafe.Pointer(in.MaintainedKubernetesVersions))
	out.ExpirationDurationMaintainedVersion = (*v1.Duration)(unsafe.Pointer(in.ExpirationDurationMaintainedVersion))
	out.ExpirationDurationUnmaintainedVersion = (*v1.Duration)(unsafe.Pointer(in.ExpirationDurationUnmaintainedVersion))
...
// Convert_config_KubernetesVersionManagement_To_v1alpha1_KubernetesVersionManagement is an autogenerated conversion function.
func Convert_config_KubernetesVersionManagement_To_v1alpha1_KubernetesVersionManagement(in *config.KubernetesVersionManagement, out *KubernetesVersionManagement, s conversion.Scope) error {
	return autoConvert_config_KubernetesVersionManagement_To_v1alpha1_KubernetesVersionManagement(in, out, s)
}
...
func autoConvert_v1alpha1_MachineImageVersionManagement_To_config_MachineImageVersionManagement(in *MachineImageVersionManagement, out *config.MachineImageVersionManagement, s conversion.Scope) error {
	out.Enabled = in.Enabled
	out.ExpirationDuration = (*v1.Duration)(unsafe.Pointer(in.ExpirationDuration))
	return nil
}

// Convert_v1alpha1_MachineImageVersionManagement_To_config_MachineImageVersionManagement is an autogenerated conversion function.
func Convert_v1alpha1_MachineImageVersionManagement_To_config_MachineImageVersionManagement(in *MachineImageVersionManagement, out *config.MachineImageVersionManagement, s conversion.Scope) error {
	return autoConvert_v1alpha1_MachineImageVersionManagement_To_config_MachineImageVersionManagement(in, out, s)
}

func autoConvert_config_MachineImageVersionManagement_To_v1alpha1_MachineImageVersionManagement(in *config.MachineImageVersionManagement, out *MachineImageVersionManagement, s conversion.Scope) error {
	out.Enabled = in.Enabled
	out.ExpirationDuration = (*v1.Duration)(unsafe.Pointer(in.ExpirationDuration))
	return nil
}

// Convert_config_MachineImageVersionManagement_To_v1alpha1_MachineImageVersionManagement is an autogenerated conversion function.
func Convert_config_MachineImageVersionManagement_To_v1alpha1_MachineImageVersionManagement(in *config.MachineImageVersionManagement, out *MachineImageVersionManagement, s conversion.Scope) error {
	return autoConvert_config_MachineImageVersionManagement_To_v1alpha1_MachineImageVersionManagement(in, out, s)
}
