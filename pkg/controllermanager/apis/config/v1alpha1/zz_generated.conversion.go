...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*VersionMaintenance)(nil), (*config.VersionMaintenance)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_VersionMaintenance_To_config_VersionMaintenance(a.(*VersionMaintenance), b.(*config.VersionMaintenance), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.VersionMaintenance)(nil), (*VersionMaintenance)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_VersionMaintenance_To_v1alpha1_VersionMaintenance(a.(*config.VersionMaintenance), b.(*VersionMaintenance), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*VersionManagement)(nil), (*config.VersionManagement)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_VersionManagement_To_config_VersionManagement(a.(*VersionManagement), b.(*config.VersionManagement), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.VersionManagement)(nil), (*VersionManagement)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_VersionManagement_To_v1alpha1_VersionManagement(a.(*config.VersionManagement), b.(*VersionManagement), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_CloudProfileControllerConfiguration_To_config_CloudProfileControllerConfiguration(in *CloudProfileControllerConfiguration, out *config.CloudProfileControllerConfiguration, s conversion.Scope) error {
	...
	out.KubernetesVersionManagement = (*config.VersionManagement)(unsafe.Pointer(in.KubernetesVersionManagement))
	out.MachineImageVersionManagement = (*config.VersionManagement)(unsafe.Pointer(in.MachineImageVersionManagement))
	return nil
}
...
func autoConvert_config_CloudProfileControllerConfiguration_To_v1alpha1_CloudProfileControllerConfiguration(in *config.CloudProfileControllerConfiguration, out *CloudProfileControllerConfiguration, s conversion.Scope) error {
	out.ConcurrentSyncs = in.ConcurrentSyncs
	out.KubernetesVersionManagement = (*VersionManagement)(unsafe.Pointer(in.KubernetesVersionManagement))
	out.MachineImageVersionManagement = (*VersionManagement)(unsafe.Pointer(in.MachineImageVersionManagement))
	return nil
}
...
func autoConvert_v1alpha1_VersionMaintenance_To_config_VersionMaintenance(in *VersionMaintenance, out *config.VersionMaintenance, s conversion.Scope) error {
	out.MaintainedVersions = in.MaintainedVersions
	out.ExpirationDurationUnmaintainedVersion = in.ExpirationDurationUnmaintainedVersion
	return nil
}

// Convert_v1alpha1_VersionMaintenance_To_config_VersionMaintenance is an autogenerated conversion function.
func Convert_v1alpha1_VersionMaintenance_To_config_VersionMaintenance(in *VersionMaintenance, out *config.VersionMaintenance, s conversion.Scope) error {
	return autoConvert_v1alpha1_VersionMaintenance_To_config_VersionMaintenance(in, out, s)
}

func autoConvert_config_VersionMaintenance_To_v1alpha1_VersionMaintenance(in *config.VersionMaintenance, out *VersionMaintenance, s conversion.Scope) error {
	out.MaintainedVersions = in.MaintainedVersions
	out.ExpirationDurationUnmaintainedVersion = in.ExpirationDurationUnmaintainedVersion
	return nil
}

// Convert_config_VersionMaintenance_To_v1alpha1_VersionMaintenance is an autogenerated conversion function.
func Convert_config_VersionMaintenance_To_v1alpha1_VersionMaintenance(in *config.VersionMaintenance, out *VersionMaintenance, s conversion.Scope) error {
	return autoConvert_config_VersionMaintenance_To_v1alpha1_VersionMaintenance(in, out, s)
}

func autoConvert_v1alpha1_VersionManagement_To_config_VersionManagement(in *VersionManagement, out *config.VersionManagement, s conversion.Scope) error {
	out.ExpirationDuration = (*v1.Duration)(unsafe.Pointer(in.ExpirationDuration))
	out.VersionMaintenance = (*config.VersionMaintenance)(unsafe.Pointer(in.VersionMaintenance))
	return nil
}

// Convert_v1alpha1_VersionManagement_To_config_VersionManagement is an autogenerated conversion function.
func Convert_v1alpha1_VersionManagement_To_config_VersionManagement(in *VersionManagement, out *config.VersionManagement, s conversion.Scope) error {
	return autoConvert_v1alpha1_VersionManagement_To_config_VersionManagement(in, out, s)
}

func autoConvert_config_VersionManagement_To_v1alpha1_VersionManagement(in *config.VersionManagement, out *VersionManagement, s conversion.Scope) error {
	out.ExpirationDuration = (*v1.Duration)(unsafe.Pointer(in.ExpirationDuration))
	out.VersionMaintenance = (*VersionMaintenance)(unsafe.Pointer(in.VersionMaintenance))
	return nil
}

// Convert_config_VersionManagement_To_v1alpha1_VersionManagement is an autogenerated conversion function.
func Convert_config_VersionManagement_To_v1alpha1_VersionManagement(in *config.VersionManagement, out *VersionManagement, s conversion.Scope) error {
	return autoConvert_config_VersionManagement_To_v1alpha1_VersionManagement(in, out, s)
}
