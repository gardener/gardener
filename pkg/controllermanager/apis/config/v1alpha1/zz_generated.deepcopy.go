...
func (in *ControllerManagerControllerConfiguration) DeepCopyInto(out *ControllerManagerControllerConfiguration) {
	*out = *in
	...
	if in.CredentialsBindingReferenceCleaner != nil {
		in, out := &in.CredentialsBindingReferenceCleaner, &out.CredentialsBindingReferenceCleaner
		*out = new(CredentialsBindingReferenceCleanerControllerConfiguration)
		(*in).DeepCopyInto(*out)
	}
	if in.Seed != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CredentialsBindingReferenceCleanerControllerConfiguration) DeepCopyInto(out *CredentialsBindingReferenceCleanerControllerConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CredentialsBindingReferenceCleanerControllerConfiguration.
func (in *CredentialsBindingReferenceCleanerControllerConfiguration) DeepCopy() *CredentialsBindingReferenceCleanerControllerConfiguration {
	if in == nil {
		return nil
	}
	out := new(CredentialsBindingReferenceCleanerControllerConfiguration)
