...
func (in *ControllerManagerControllerConfiguration) DeepCopyInto(out *ControllerManagerControllerConfiguration) {
	*out = *in
	...
	if in.SecretBindingProviderPopulator != nil {
		in, out := &in.SecretBindingProviderPopulator, &out.SecretBindingProviderPopulator
		*out = new(SecretBindingProviderPopulatorControllerConfiguration)
		**out = **in
	}
	if in.Seed != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretBindingProviderPopulatorControllerConfiguration) DeepCopyInto(out *SecretBindingProviderPopulatorControllerConfiguration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretBindingProviderPopulatorControllerConfiguration.
func (in *SecretBindingProviderPopulatorControllerConfiguration) DeepCopy() *SecretBindingProviderPopulatorControllerConfiguration {
	if in == nil {
		return nil
	}
	out := new(SecretBindingProviderPopulatorControllerConfiguration)
