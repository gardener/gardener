...
var APIGroupControllerMap = map[string]map[string]versionutils.VersionRange{
	...
	"certificates/v1": {
		...
		"csrcleaner":   {},
		"csrsigning":   {},
		"kube-apiserver-serving-clustertrustbundle-publisher-controller": {AddedInVersion: "1.37"},
		"podcertificaterequest-cleaner-controller":                       {AddedInVersion: "1.37"},
	},
	...
	"certificates/v1beta1": {
		...
		"podcertificaterequest-cleaner-controller":                       {AddedInVersion: "1.35", RemovedInVersion: "1.37"},
	},
	"coordination/v1": {
		"nodelifecycle":      {},
		"storage-version-gc": {},
	...
	"resource/v1": {
		...
		"resourcepoolstatusrequest-controller": {AddedInVersion: "1.37"},
	},
	"resource/v1alpha2": {
	...
	"resource/v1beta2": {
		"device-taint-eviction-controller": {AddedInVersion: "1.36", RemovedInVersion: "1.37"},
	},
	"scheduling/v1alpha2": {
		"device-taint-eviction-controller": {AddedInVersion: "1.36", RemovedInVersion: "1.37"},
		"job-controller":                   {AddedInVersion: "1.36", RemovedInVersion: "1.37"},
		"podgroup-protection-controller":   {AddedInVersion: "1.36", RemovedInVersion: "1.37"},
		"resourceclaim-controller":         {AddedInVersion: "1.36", RemovedInVersion: "1.37"},
	},
	"scheduling/v1beta1": {
		"device-taint-eviction-controller": {AddedInVersion: "1.37"},
		"job-controller":                   {AddedInVersion: "1.37"},
		"podgroup-protection-controller":   {AddedInVersion: "1.37"},
		"resourceclaim-controller":         {AddedInVersion: "1.37"},
	},
	"storage/v1": {
	...
	"storagemigration/v1": {
		"storage-version-migrator-controller": {AddedInVersion: "1.37"},
	},
	...
	"storagemigration/v1beta1": {
		"storage-version-migrator-controller": {AddedInVersion: "1.35", RemovedInVersion: "1.37"},
	},
	"v1": {
		"attachdetach":                         {},
		"bootstrapsigner":                      {},
		"cloud-node":                           {RemovedInVersion: "1.37"},
		"cloud-node-lifecycle":                 {RemovedInVersion: "1.37"},
		"cronjob":                              {},
		"csrapproving":                         {},
		"csrsigning":                           {},
		"daemonset":                            {},
		...
		"route":                                {RemovedInVersion: "1.37"},
		"selinux-warning-controller":           {AddedInVersion: "1.32"},
		"service":                              {RemovedInVersion: "1.37"},
