...
// GetManagedSeed gets the ManagedSeed resource for the given shoot, by searching for all ManagedSeeds in the shoot namespace
// that have spec.shoot.name set to the shoot name. If no such ManagedSeeds are found, nil is returned.
