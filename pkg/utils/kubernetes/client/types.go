...
type Cleaner interface {
	...
	Clean(ctx context.Context, c client.Client, obj runtime.Object, opts ...CleanOptionFunc) error
}
...
type GoneEnsurer interface {
	...
	EnsureGone(ctx context.Context, c client.Client, obj runtime.Object, opts ...client.ListOptionFunc) error
}

// GoneEnsurerFunc is a function that implements GoneEnsurer.
type GoneEnsurerFunc func(ctx context.Context, c client.Client, obj runtime.Object, opts ...client.ListOptionFunc) error
...
type CleanOps interface {
	...
	CleanAndEnsureGone(ctx context.Context, c client.Client, obj runtime.Object, opts ...CleanOptionFunc) error
}
