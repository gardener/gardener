...
var _ = Describe("csr", func() {
	...
	DescribeTable("#IsShootClientCert",
		...
		Entry("common name missing namespace", &x509.CertificateRequest{Subject: pkix.Name{CommonName: "gardener.cloud:system:shoot:", Organization: []string{"gardener.cloud:system:shoots"}}}, []certificatesv1.KeyUsage{certificatesv1.UsageKeyEncipherment, certificatesv1.UsageDigitalSignature, certificatesv1.UsageClientAuth}, false, ContainSubstring("common name must follow this structure")),
		...
		Entry("common name with empty namespace", &x509.CertificateRequest{Subject: pkix.Name{CommonName: "gardener.cloud:system:shoot::shoot", Organization: []string{"gardener.cloud:system:shoots"}}}, []certificatesv1.KeyUsage{certificatesv1.UsageKeyEncipherment, certificatesv1.UsageDigitalSignature, certificatesv1.UsageClientAuth}, false, ContainSubstring("common name must follow this structure")),
