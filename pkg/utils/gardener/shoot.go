...
// of the Shoot. Returns 'true' if the feature gate is not specified.
func IsAuthorizeWithSelectorsEnabled(kubeAPIServer *gardencorev1beta1.KubeAPIServerConfig) bool {
