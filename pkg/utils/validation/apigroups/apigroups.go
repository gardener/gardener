...
var (
	...
	apiGVRVersionRanges = map[string]*APIVersionRange{
		...
		"networking.k8s.io/v1alpha1/servicecidrs":                                 {VersionRange: versionutils.VersionRange{RemovedInVersion: "1.34"}},
		...
		"resource.k8s.io/v1alpha2/resourceclaimparameters":                        {VersionRange: versionutils.VersionRange{RemovedInVersion: "1.31"}},
		...
		"resource.k8s.io/v1alpha2/resourceclassparameters":                        {VersionRange: versionutils.VersionRange{RemovedInVersion: "1.31"}},
		"resource.k8s.io/v1alpha2/resourceslices":                                 {VersionRange: versionutils.VersionRange{RemovedInVersion: "1.31"}},
