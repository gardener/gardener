...
var (
	...
	apiGroupVersionRanges = map[string]*APIVersionRange{
		...
		"coordination.k8s.io/v1alpha1":          {VersionRange: versionutils.VersionRange{AddedInVersion: "1.31"}},
	...
	apiGVRVersionRanges = map[string]*APIVersionRange{
		...
		"coordination.k8s.io/v1alpha1/leasecandidates":                            {VersionRange: versionutils.VersionRange{AddedInVersion: "1.31"}},
		...
		"resource.k8s.io/v1alpha3/podschedulingcontexts":                          {VersionRange: versionutils.VersionRange{AddedInVersion: "1.31"}},
