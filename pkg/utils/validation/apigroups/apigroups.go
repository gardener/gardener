...
var (
	...
	apiGroupVersionRanges = map[string]*APIVersionRange{
		...
		"autoscaling/v1":                        {},
		"autoscaling/v2":                        {},
		"autoscaling/v2beta1":                   {VersionRange: versionutils.VersionRange{RemovedInVersion: "1.36"}},
		"autoscaling/v2beta2":                   {VersionRange: versionutils.VersionRange{RemovedInVersion: "1.36"}},
		"batch/v1":                              {},
		"batch/v1beta1":                         {},
		...
		"lifecycle.k8s.io/v1alpha1":             {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		...
		"scheduling.k8s.io/v1alpha1":            {VersionRange: versionutils.VersionRange{RemovedInVersion: "1.36"}},
		"scheduling.k8s.io/v1alpha2":            {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36", RemovedInVersion: "1.37"}},
		"scheduling.k8s.io/v1alpha3":            {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		"scheduling.k8s.io/v1beta1":             {},
		"storage.k8s.io/v1":                     {Required: true},
		"storage.k8s.io/v1alpha1":               {},
		"storage.k8s.io/v1beta1":                {},
		"storagemigration.k8s.io/v1":            {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		"storagemigration.k8s.io/v1alpha1":      {VersionRange: versionutils.VersionRange{AddedInVersion: "1.30", RemovedInVersion: "1.35"}},
		"storagemigration.k8s.io/v1beta1":       {VersionRange: versionutils.VersionRange{AddedInVersion: "1.35"}},
		"v1":                                    {Required: true, RequiredForWorkerless: true},
	}

	// Keep the list ordered alphabetically.
	apiGVRVersionRanges = map[string]*APIVersionRange{
		"admissionregistration.k8s.io/v1/mutatingadmissionpolicies":               {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
		"admissionregistration.k8s.io/v1/mutatingadmissionpolicybindings":         {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
		...
		"autoscaling/v2beta1/horizontalpodautoscalers":                            {VersionRange: versionutils.VersionRange{RemovedInVersion: "1.36"}},
		"autoscaling/v2beta2/horizontalpodautoscalers":                            {VersionRange: versionutils.VersionRange{RemovedInVersion: "1.36"}},
		"batch/v1/cronjobs":                                                       {},
		"batch/v1/jobs":                                                           {},
		"batch/v1beta1/cronjobs":                                                  {},
		"certificates.k8s.io/v1/certificatesigningrequests":                       {Required: true},
		"certificates.k8s.io/v1/clustertrustbundles":                              {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		"certificates.k8s.io/v1/podcertificaterequests":                           {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		"certificates.k8s.io/v1alpha1/clustertrustbundles":                        {},
		"certificates.k8s.io/v1alpha1/podcertificaterequests":                     {VersionRange: versionutils.VersionRange{AddedInVersion: "1.34", RemovedInVersion: "1.35"}},
		...
		"certificates.k8s.io/v1beta1/podcertificaterequests":                      {VersionRange: versionutils.VersionRange{AddedInVersion: "1.35"}},
		...
		"lifecycle.k8s.io/v1alpha1/evictionrequests":                              {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		"lifecycle.k8s.io/v1alpha1/evictions":                                     {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		...
		"resource.k8s.io/v1/devicetaintrules":                                     {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		...
		"resource.k8s.io/v1alpha2/resourceclaimtemplates":                         {VersionRange: versionutils.VersionRange{RemovedInVersion: "1.31"}},
		...
		"resource.k8s.io/v1alpha3/resourcepoolstatusrequests":                     {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
		...
		"resource.k8s.io/v1beta2/devicetaintrules":                                {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
		...
		"scheduling.k8s.io/v1alpha1/priorityclasses":                              {VersionRange: versionutils.VersionRange{RemovedInVersion: "1.36"}},
		"scheduling.k8s.io/v1alpha1/workloads":                                    {VersionRange: versionutils.VersionRange{AddedInVersion: "1.35", RemovedInVersion: "1.36"}},
		"scheduling.k8s.io/v1alpha2/podgroups":                                    {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36", RemovedInVersion: "1.37"}},
		"scheduling.k8s.io/v1alpha2/workloads":                                    {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36", RemovedInVersion: "1.37"}},
		"scheduling.k8s.io/v1alpha3/compositepodgroups":                           {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		"scheduling.k8s.io/v1alpha3/podgroups":                                    {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		"scheduling.k8s.io/v1alpha3/workloads":                                    {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		"scheduling.k8s.io/v1beta1/podgroups":                                     {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		"scheduling.k8s.io/v1beta1/priorityclasses":                               {},
		"scheduling.k8s.io/v1beta1/workloads":                                     {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		...
		"storagemigration.k8s.io/v1/storageversionmigrations":                     {VersionRange: versionutils.VersionRange{AddedInVersion: "1.37"}},
		"storagemigration.k8s.io/v1alpha1/storageversionmigrations":               {VersionRange: versionutils.VersionRange{AddedInVersion: "1.30", RemovedInVersion: "1.35"}},
		"storagemigration.k8s.io/v1beta1/storageversionmigrations":                {VersionRange: versionutils.VersionRange{AddedInVersion: "1.35"}},
