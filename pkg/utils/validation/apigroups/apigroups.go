...
var (
	...
	apiGroupVersionRanges = map[string]*APIVersionRange{
		...
		"scheduling.k8s.io/v1alpha2":            {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
	...
	apiGVRVersionRanges = map[string]*APIVersionRange{
		...
		"scheduling.k8s.io/v1alpha2/podgroups":                                    {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
		"scheduling.k8s.io/v1alpha2/workloads":                                    {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
