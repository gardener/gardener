...
var (
	...
	admissionPluginsVersionRanges = map[string]*AdmissionPluginVersionRange{
		...
		"JobValidation":                        {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36", RemovedInVersion: "1.37"}},
		...
		"PodGroupProtection":                   {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
		"PodGroupWorkloadExists":               {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36", RemovedInVersion: "1.37"}},
		"PodNodeSelector":                      {AllowsConfiguration: true},
		"PodResizeValidator":                   {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
