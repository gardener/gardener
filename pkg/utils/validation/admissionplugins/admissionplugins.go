...
var (
	...
	admissionPluginsVersionRanges = map[string]*AdmissionPluginVersionRange{
		...
		"JobValidation":                        {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
		...
		"PodGroupWorkloadExists":               {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
