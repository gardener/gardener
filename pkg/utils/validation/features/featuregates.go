...
var featureGateVersionRanges = map[string]*FeatureGateVersionRange{
	...
	"AggregatedDiscoveryRemoveBetaType":                {Default: true, VersionRange: versionutils.VersionRange{AddedInVersion: "1.0", RemovedInVersion: "1.33"}},
	...
	"GitRepoVolumeDriver":                              {VersionRange: versionutils.VersionRange{AddedInVersion: "1.0", RemovedInVersion: "1.33"}},
	...
	"LegacySidecarContainers":                          {VersionRange: versionutils.VersionRange{AddedInVersion: "1.0", RemovedInVersion: "1.33"}},
	...
	"OrderedNamespaceDeletion":                         {Default: true, VersionRange: versionutils.VersionRange{AddedInVersion: "1.30"}},
