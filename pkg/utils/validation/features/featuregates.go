...
var featureGateVersionRanges = map[string]*FeatureGateVersionRange{
	...
	"CloudDualStackNodeIPs":                          {Default: true, LockedToDefaultInVersion: "1.30"},
	"ClusterTrustBundle":                             {},
	...
	"ConsistentHTTPGetHandlers":                      {Default: true, LockedToDefaultInVersion: "1.30", VersionRange: versionutils.VersionRange{RemovedInVersion: "1.31"}},
	...
	"LegacyServiceAccountTokenTracking":              {Default: true, LockedToDefaultInVersion: "1.28", VersionRange: versionutils.VersionRange{RemovedInVersion: "1.30"}},
	...
	"MinimizeIPTablesRestore":                        {Default: true, LockedToDefaultInVersion: "1.28", VersionRange: versionutils.VersionRange{RemovedInVersion: "1.30"}},
	...
	"NewVolumeManagerReconstruction":                 {Default: true, LockedToDefaultInVersion: "1.30"},
	...
	"StableLoadBalancerNodeSet":                      {Default: true, LockedToDefaultInVersion: "1.30"},
