...
var featureGateVersionRanges = map[string]*FeatureGateVersionRange{
	...
	"NetworkPolicyStatus":                            {AddedInVersion: "1.24", RemovedInVersion: "1.28"},
	...
	"NodeOutOfServiceVolumeDetach":                   {Default: true, AddedInVersion: "1.24", LockedToDefaultInVersion: "1.28"},
	...
	"ServiceIPStaticSubrange":                        {Default: true, AddedInVersion: "1.24", LockedToDefaultInVersion: "1.26", RemovedInVersion: "1.28"},
