...
var featureGateVersionRanges = map[string]*FeatureGateVersionRange{
	...
	"CSINodeExpandSecret":                            {Default: true, LockedToDefaultInVersion: "1.29", VersionRange: versionutils.VersionRange{AddedInVersion: "1.25"}},
	...
	"KMSv2":                                          {Default: true, LockedToDefaultInVersion: "1.29", VersionRange: versionutils.VersionRange{AddedInVersion: "1.25"}},
	...
	"MultiCIDRRangeAllocator":                        {VersionRange: versionutils.VersionRange{AddedInVersion: "1.25", RemovedInVersion: "1.29"}},
	...
	"RetroactiveDefaultStorageClass":                 {Default: true, VersionRange: versionutils.VersionRange{AddedInVersion: "1.25", RemovedInVersion: "1.29"}, LockedToDefaultInVersion: "1.28"},
	...
	"SELinuxMountReadWriteOncePod":                   {Default: true, LockedToDefaultInVersion: "1.29", VersionRange: versionutils.VersionRange{AddedInVersion: "1.25"}},
