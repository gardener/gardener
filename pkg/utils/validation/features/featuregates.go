...
var featureGateVersionRanges = map[string]*FeatureGateVersionRange{
	...
	"GangScheduling":                                       {VersionRange: versionutils.VersionRange{AddedInVersion: "1.35"}},
	...
	"InPlacePodVerticalScalingInitContainers":              {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
	...
	"NodeDeclaredFeatures":                                 {VersionRange: versionutils.VersionRange{AddedInVersion: "1.35"}},
	...
	"PLEGOnDemandRelist":                                   {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
	...
	"WindowsHostNetwork":                                   {},
	"WorkloadAwarePreemption":                              {VersionRange: versionutils.VersionRange{AddedInVersion: "1.36"}},
