...
var featureGateVersionRanges = map[string]*FeatureGateVersionRange{
	...
	"APISelfSubjectReview":                           {Default: true, VersionRange: versionutils.VersionRange{AddedInVersion: "1.26", RemovedInVersion: "1.30"}, LockedToDefaultInVersion: "1.28"},
	"APIServerIdentity":                              {},
	"APIServerTracing":                               {},
	...
	"LegacyServiceAccountTokenTracking":              {Default: true, VersionRange: versionutils.VersionRange{AddedInVersion: "1.26", RemovedInVersion: "1.30"}, LockedToDefaultInVersion: "1.28"},
	...
	"MinimizeIPTablesRestore":                        {Default: true, VersionRange: versionutils.VersionRange{AddedInVersion: "1.26", RemovedInVersion: "1.30"}, LockedToDefaultInVersion: "1.28"},
