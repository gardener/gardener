...
// TODO(timuthy): Remove this file after sources have been vendored to Kubernetes 1.26, see https://github.com/kubernetes/kubernetes/pull/112377.

// Set is a set of the same type elements, implemented via map[comparable]struct{} for minimal memory consumption.
type Set[T comparable] map[T]sets.Empty

// cast transforms specified set to generic Set[T].
func cast[T comparable](s map[T]sets.Empty) Set[T] { return s }
