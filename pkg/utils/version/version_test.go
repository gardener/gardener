...
var _ = Describe("Version", func() {
	DescribeTable("Constraints",
		...
		Entry("ConstraintK8sEqual120, success w/ suffix", ConstraintK8sEqual120, semver.MustParse("1.20.1-foo.12"), BeTrue()),
		Entry("ConstraintK8sEqual120, failure w/ suffix", ConstraintK8sEqual120, semver.MustParse("1.19.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sGreaterEqual120, success w/ suffix", ConstraintK8sGreaterEqual120, semver.MustParse("1.20.0-foo.12"), BeTrue()),
		Entry("ConstraintK8sGreaterEqual120, failure w/ suffix", ConstraintK8sGreaterEqual120, semver.MustParse("1.19.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sLessEqual121, success w/ suffix", ConstraintK8sLessEqual121, semver.MustParse("1.20.0-foo.12"), BeTrue()),
		Entry("ConstraintK8sLessEqual121, failure w/ suffix", ConstraintK8sLessEqual121, semver.MustParse("1.22.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sEqual121, success w/ suffix", ConstraintK8sEqual121, semver.MustParse("1.21.1-foo.12"), BeTrue()),
		Entry("ConstraintK8sEqual121, failure w/ suffix", ConstraintK8sEqual121, semver.MustParse("1.20.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sGreaterEqual121, success w/ suffix", ConstraintK8sGreaterEqual121, semver.MustParse("1.21.0-foo.12"), BeTrue()),
		...
		Entry("ConstraintK8sLessEqual122, success w/ suffix", ConstraintK8sLessEqual122, semver.MustParse("1.21.0-foo.12"), BeTrue()),
		Entry("ConstraintK8sLessEqual122, failure w/ suffix", ConstraintK8sLessEqual122, semver.MustParse("1.23.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sEqual122, success w/ suffix", ConstraintK8sEqual122, semver.MustParse("1.22.1-foo.12"), BeTrue()),
		Entry("ConstraintK8sEqual122, failure w/ suffix", ConstraintK8sEqual122, semver.MustParse("1.21.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sGreaterEqual122, success w/ suffix", ConstraintK8sGreaterEqual122, semver.MustParse("1.22.0-foo.12"), BeTrue()),
		Entry("ConstraintK8sGreaterEqual122, failure w/ suffix", ConstraintK8sGreaterEqual122, semver.MustParse("1.21.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sGreaterEqual123, success w/ suffix", ConstraintK8sGreaterEqual123, semver.MustParse("1.23.0-foo.12"), BeTrue()),
		Entry("ConstraintK8sGreaterEqual123, failure w/ suffix", ConstraintK8sGreaterEqual123, semver.MustParse("1.22.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sEqual124, success w/ suffix", ConstraintK8sEqual124, semver.MustParse("1.24.1-foo.12"), BeTrue()),
		Entry("ConstraintK8sEqual124, failure w/ suffix", ConstraintK8sEqual124, semver.MustParse("1.23.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sLess124, success w/ suffix", ConstraintK8sLess124, semver.MustParse("1.23.1-foo.12"), BeTrue()),
		Entry("ConstraintK8sLess124, failure w/ suffix", ConstraintK8sLess124, semver.MustParse("1.24.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sGreaterEqual125, success w/ suffix", ConstraintK8sGreaterEqual125, semver.MustParse("1.25.0-foo.12"), BeTrue()),
		Entry("ConstraintK8sGreaterEqual125, failure w/ suffix", ConstraintK8sGreaterEqual125, semver.MustParse("1.24.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sLess125, success w/ suffix", ConstraintK8sLess125, semver.MustParse("1.24.1-foo.12"), BeTrue()),
		Entry("ConstraintK8sLess125, failure w/ suffix", ConstraintK8sLess125, semver.MustParse("1.25.0-foo.12"), BeFalse()),
		...
		Entry("ConstraintK8sGreaterEqual126, success w/ suffix", ConstraintK8sGreaterEqual126, semver.MustParse("1.26.0-foo.12"), BeTrue()),
		Entry("ConstraintK8sGreaterEqual126, failure w/ suffix", ConstraintK8sGreaterEqual126, semver.MustParse("1.25.0-foo.12"), BeFalse()),
	)
	...
	DescribeTable("#CompareVersions",
		...
		Entry("match w/ suffix", "1.2.3-foo.12", ">", "1.2.2-foo.23", BeTrue()),
		Entry("no match w/ suffix", "1.2.3-foo.12", ">", "1.2.4-foo.34", BeFalse()),
	)
