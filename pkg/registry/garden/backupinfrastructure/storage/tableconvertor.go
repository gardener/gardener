...
func (c *convertor) ConvertToTable(ctx context.Context, obj runtime.Object, tableOptions runtime.Object) (*metav1beta1.Table, error) {
	...
	table.Rows, err = metatable.MetaToTableRow(obj, func(obj runtime.Object, m metav1.Object, name, age string) ([]interface{}, error) {
		...
		cells = append(cells, backupInfrastructure.Name)
		cells = append(cells, backupInfrastructure.Spec.Seed)
		if lastOp := backupInfrastructure.Status.LastOperation; lastOp != nil {
		...
		cells = append(cells, metatable.ConvertToHumanReadableDateType(backupInfrastructure.CreationTimestamp))
