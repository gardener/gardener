...
func NewStorage(cloudProfiles rest.StandardStorage, optsGetter generic.RESTOptionsGetter) SeedStorage {
	seedRest, seedStatusRest := NewREST(cloudProfiles, optsGetter)
...
func NewREST(cloudProfiles rest.StandardStorage, optsGetter generic.RESTOptionsGetter) (*REST, *StatusREST) {
