...
func newTableConvertor() rest.TableConvertor {
	return &convertor{
		headers: []metav1beta1.TableColumnDefinition{
			...
			{Name: "Entries", Type: "string", Description: swaggerMetadataDescriptions["entries"]},
...
func (c *convertor) ConvertToTable(ctx context.Context, o runtime.Object, _ runtime.Object) (*metav1beta1.Table, error) {
	var (
		err   error
	...
	table.Rows, err = metatable.MetaToTableRow(o, func(o runtime.Object, m metav1.Object, name, age string) ([]interface{}, error) {
		var (
			obj   = o.(*core.ShootExtensionStatus)
			cells []interface{}
		)

		cells = append(cells, obj.Name)
		cells = append(cells, len(obj.Statuses))
