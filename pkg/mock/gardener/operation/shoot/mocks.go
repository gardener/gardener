...
// Source: github.com/gardener/gardener/pkg/operation/shoot (interfaces: ExtensionContainerRuntime,ExtensionControlPlane,ExtensionWorker,ExtensionInfrastructure)
...
// MockExtensionControlPlane is a mock of ExtensionControlPlane interface.
type MockExtensionControlPlane struct {
	ctrl     *gomock.Controller
	recorder *MockExtensionControlPlaneMockRecorder
}

// MockExtensionControlPlaneMockRecorder is the mock recorder for MockExtensionControlPlane.
type MockExtensionControlPlaneMockRecorder struct {
	mock *MockExtensionControlPlane
}

// NewMockExtensionControlPlane creates a new mock instance.
func NewMockExtensionControlPlane(ctrl *gomock.Controller) *MockExtensionControlPlane {
	mock := &MockExtensionControlPlane{ctrl: ctrl}
	mock.recorder = &MockExtensionControlPlaneMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockExtensionControlPlane) EXPECT() *MockExtensionControlPlaneMockRecorder {
	return m.recorder
}

// Deploy mocks base method.
func (m *MockExtensionControlPlane) Deploy(arg0 context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Deploy", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// Deploy indicates an expected call of Deploy.
func (mr *MockExtensionControlPlaneMockRecorder) Deploy(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Deploy", reflect.TypeOf((*MockExtensionControlPlane)(nil).Deploy), arg0)
}

// Destroy mocks base method.
func (m *MockExtensionControlPlane) Destroy(arg0 context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Destroy", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// Destroy indicates an expected call of Destroy.
func (mr *MockExtensionControlPlaneMockRecorder) Destroy(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Destroy", reflect.TypeOf((*MockExtensionControlPlane)(nil).Destroy), arg0)
}

// Migrate mocks base method.
func (m *MockExtensionControlPlane) Migrate(arg0 context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Migrate", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// Migrate indicates an expected call of Migrate.
func (mr *MockExtensionControlPlaneMockRecorder) Migrate(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Migrate", reflect.TypeOf((*MockExtensionControlPlane)(nil).Migrate), arg0)
}

// ProviderStatus mocks base method.
func (m *MockExtensionControlPlane) ProviderStatus() *runtime.RawExtension {
	m.ctrl.T.Helper()
...
func (mr *MockExtensionControlPlaneMockRecorder) ProviderStatus() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProviderStatus", reflect.TypeOf((*MockExtensionControlPlane)(nil).ProviderStatus))
}

// Restore mocks base method.
func (m *MockExtensionControlPlane) Restore(arg0 context.Context, arg1 *v1alpha1.ShootState) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Restore", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
...
// Restore indicates an expected call of Restore.
func (mr *MockExtensionControlPlaneMockRecorder) Restore(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Restore", reflect.TypeOf((*MockExtensionControlPlane)(nil).Restore), arg0, arg1)
}

// SetInfrastructureProviderStatus mocks base method.
func (m *MockExtensionControlPlane) SetInfrastructureProviderStatus(arg0 *runtime.RawExtension) {
	m.ctrl.T.Helper()
...
func (mr *MockExtensionControlPlaneMockRecorder) SetInfrastructureProviderStatus(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetInfrastructureProviderStatus", reflect.TypeOf((*MockExtensionControlPlane)(nil).SetInfrastructureProviderStatus), arg0)
}

// Wait mocks base method.
func (m *MockExtensionControlPlane) Wait(arg0 context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Wait", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// Wait indicates an expected call of Wait.
func (mr *MockExtensionControlPlaneMockRecorder) Wait(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Wait", reflect.TypeOf((*MockExtensionControlPlane)(nil).Wait), arg0)
}

// WaitCleanup mocks base method.
func (m *MockExtensionControlPlane) WaitCleanup(arg0 context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WaitCleanup", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// WaitCleanup indicates an expected call of WaitCleanup.
func (mr *MockExtensionControlPlaneMockRecorder) WaitCleanup(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitCleanup", reflect.TypeOf((*MockExtensionControlPlane)(nil).WaitCleanup), arg0)
}

// WaitMigrate mocks base method.
func (m *MockExtensionControlPlane) WaitMigrate(arg0 context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WaitMigrate", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// WaitMigrate indicates an expected call of WaitMigrate.
func (mr *MockExtensionControlPlaneMockRecorder) WaitMigrate(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitMigrate", reflect.TypeOf((*MockExtensionControlPlane)(nil).WaitMigrate), arg0)
}
