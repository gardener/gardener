...
//
//	mockgen -package predicate -destination=mocks.go sigs.k8s.io/controller-runtime/pkg/predicate Predicate
//
...
func (mr *MockPredicateMockRecorder) Generic(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPredicateMockRecorder) Update(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
