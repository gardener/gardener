...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*AgentModeMonitoringConfig)(nil), (*config.AgentModeMonitoringConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AgentModeMonitoringConfig_To_config_AgentModeMonitoringConfig(a.(*AgentModeMonitoringConfig), b.(*config.AgentModeMonitoringConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.AgentModeMonitoringConfig)(nil), (*AgentModeMonitoringConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_AgentModeMonitoringConfig_To_v1alpha1_AgentModeMonitoringConfig(a.(*config.AgentModeMonitoringConfig), b.(*AgentModeMonitoringConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AgentModeMonitoringConfig_To_config_AgentModeMonitoringConfig(in *AgentModeMonitoringConfig, out *config.AgentModeMonitoringConfig, s conversion.Scope) error {
	out.Enabled = (*bool)(unsafe.Pointer(in.Enabled))
	return nil
}

// Convert_v1alpha1_AgentModeMonitoringConfig_To_config_AgentModeMonitoringConfig is an autogenerated conversion function.
func Convert_v1alpha1_AgentModeMonitoringConfig_To_config_AgentModeMonitoringConfig(in *AgentModeMonitoringConfig, out *config.AgentModeMonitoringConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_AgentModeMonitoringConfig_To_config_AgentModeMonitoringConfig(in, out, s)
}

func autoConvert_config_AgentModeMonitoringConfig_To_v1alpha1_AgentModeMonitoringConfig(in *config.AgentModeMonitoringConfig, out *AgentModeMonitoringConfig, s conversion.Scope) error {
	out.Enabled = (*bool)(unsafe.Pointer(in.Enabled))
	return nil
}

// Convert_config_AgentModeMonitoringConfig_To_v1alpha1_AgentModeMonitoringConfig is an autogenerated conversion function.
func Convert_config_AgentModeMonitoringConfig_To_v1alpha1_AgentModeMonitoringConfig(in *config.AgentModeMonitoringConfig, out *AgentModeMonitoringConfig, s conversion.Scope) error {
	return autoConvert_config_AgentModeMonitoringConfig_To_v1alpha1_AgentModeMonitoringConfig(in, out, s)
}
