...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NodeToleration)(nil), (*config.NodeToleration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NodeToleration_To_config_NodeToleration(a.(*NodeToleration), b.(*config.NodeToleration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NodeToleration)(nil), (*NodeToleration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NodeToleration_To_v1alpha1_NodeToleration(a.(*config.NodeToleration), b.(*NodeToleration), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*ShootIssuer)(nil), (*config.ShootIssuer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ShootIssuer_To_config_ShootIssuer(a.(*ShootIssuer), b.(*config.ShootIssuer), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ShootIssuer)(nil), (*ShootIssuer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ShootIssuer_To_v1alpha1_ShootIssuer(a.(*config.ShootIssuer), b.(*ShootIssuer), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_GardenletConfiguration_To_config_GardenletConfiguration(in *GardenletConfiguration, out *config.GardenletConfiguration, s conversion.Scope) error {
	...
	out.ShootIssuer = (*config.ShootIssuer)(unsafe.Pointer(in.ShootIssuer))
	return nil
}
...
func autoConvert_config_GardenletConfiguration_To_v1alpha1_GardenletConfiguration(in *config.GardenletConfiguration, out *GardenletConfiguration, s conversion.Scope) error {
	...
	out.ShootIssuer = (*ShootIssuer)(unsafe.Pointer(in.ShootIssuer))
	return nil
}
...
func autoConvert_v1alpha1_NodeToleration_To_config_NodeToleration(in *NodeToleration, out *config.NodeToleration, s conversion.Scope) error {
...
func Convert_v1alpha1_NodeToleration_To_config_NodeToleration(in *NodeToleration, out *config.NodeToleration, s conversion.Scope) error {
	return autoConvert_v1alpha1_NodeToleration_To_config_NodeToleration(in, out, s)
}

func autoConvert_config_NodeToleration_To_v1alpha1_NodeToleration(in *config.NodeToleration, out *NodeToleration, s conversion.Scope) error {
	out.DefaultNotReadyTolerationSeconds = (*int64)(unsafe.Pointer(in.DefaultNotReadyTolerationSeconds))
	out.DefaultUnreachableTolerationSeconds = (*int64)(unsafe.Pointer(in.DefaultUnreachableTolerationSeconds))
	return nil
}
...
func Convert_config_NodeToleration_To_v1alpha1_NodeToleration(in *config.NodeToleration, out *NodeToleration, s conversion.Scope) error {
	return autoConvert_config_NodeToleration_To_v1alpha1_NodeToleration(in, out, s)
}
...
func autoConvert_v1alpha1_ShootIssuer_To_config_ShootIssuer(in *ShootIssuer, out *config.ShootIssuer, s conversion.Scope) error {
	out.Hostname = in.Hostname
	return nil
}

// Convert_v1alpha1_ShootIssuer_To_config_ShootIssuer is an autogenerated conversion function.
func Convert_v1alpha1_ShootIssuer_To_config_ShootIssuer(in *ShootIssuer, out *config.ShootIssuer, s conversion.Scope) error {
	return autoConvert_v1alpha1_ShootIssuer_To_config_ShootIssuer(in, out, s)
}

func autoConvert_config_ShootIssuer_To_v1alpha1_ShootIssuer(in *config.ShootIssuer, out *ShootIssuer, s conversion.Scope) error {
	out.Hostname = in.Hostname
	return nil
}

// Convert_config_ShootIssuer_To_v1alpha1_ShootIssuer is an autogenerated conversion function.
func Convert_config_ShootIssuer_To_v1alpha1_ShootIssuer(in *config.ShootIssuer, out *ShootIssuer, s conversion.Scope) error {
	return autoConvert_config_ShootIssuer_To_v1alpha1_ShootIssuer(in, out, s)
}
...
func Convert_v1alpha1_ShootStateControllerConfiguration_To_config_ShootStateControllerConfiguration(in *ShootStateControllerConfiguration, out *config.ShootStateControllerConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha1_ShootStateControllerConfiguration_To_config_ShootStateControllerConfiguration(in, out, s)
}

func autoConvert_config_ShootStateControllerConfiguration_To_v1alpha1_ShootStateControllerConfiguration(in *config.ShootStateControllerConfiguration, out *ShootStateControllerConfiguration, s conversion.Scope) error {
	out.ConcurrentSyncs = (*int)(unsafe.Pointer(in.ConcurrentSyncs))
	out.SyncPeriod = (*v1.Duration)(unsafe.Pointer(in.SyncPeriod))
	return nil
}
