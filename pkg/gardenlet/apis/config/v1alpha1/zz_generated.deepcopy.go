...
func (in *GardenletConfiguration) DeepCopyInto(out *GardenletConfiguration) {
	*out = *in
	...
	if in.ShootIssuer != nil {
		in, out := &in.ShootIssuer, &out.ShootIssuer
		*out = new(ShootIssuer)
		**out = **in
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ShootIssuer) DeepCopyInto(out *ShootIssuer) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ShootIssuer.
func (in *ShootIssuer) DeepCopy() *ShootIssuer {
	if in == nil {
		return nil
	}
	out := new(ShootIssuer)
