...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalBlackboxExporterConfig) DeepCopyInto(out *ExternalBlackboxExporterConfig) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalBlackboxExporterConfig.
func (in *ExternalBlackboxExporterConfig) DeepCopy() *ExternalBlackboxExporterConfig {
	if in == nil {
		return nil
	}
	out := new(ExternalBlackboxExporterConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ShootMonitoringConfig) DeepCopyInto(out *ShootMonitoringConfig) {
	*out = *in
	...
	if in.ExternalBlackboxExporter != nil {
		in, out := &in.ExternalBlackboxExporter, &out.ExternalBlackboxExporter
		*out = new(ExternalBlackboxExporterConfig)
		**out = **in
	}
