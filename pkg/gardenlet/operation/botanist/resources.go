...
func (b *Botanist) DeployReferencedResources(ctx context.Context) error {
	...
	return managedresources.CreateFromUnstructured(ctx, b.SeedClientSet.Client(), b.Shoot.ControlPlaneNamespace, managedResourceNameReferencedResources,
...
func (b *Botanist) DestroyReferencedResources(ctx context.Context) error {
	return client.IgnoreNotFound(managedresources.Delete(ctx, b.SeedClientSet.Client(), b.Shoot.ControlPlaneNamespace, managedResourceNameReferencedResources, false))
}
