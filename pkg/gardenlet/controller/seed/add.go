...
func AddToManager(
	...
	if err := lease.AddToManager(mgr, gardenCluster, seedClientSet.RESTClient(), *cfg.Controllers.Seed, healthManager, cfg.SeedConfig.Name, nil, new(gardencorev1beta1.GardenerSeedLeaseNamespace)); err != nil {
