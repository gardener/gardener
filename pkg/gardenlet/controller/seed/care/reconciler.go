...
func (r *Reconciler) Reconcile(reconcileCtx context.Context, req reconcile.Request) (reconcile.Result, error) {
	...
	updatedConditions := NewHealthCheck(seed, r.SeedClient, r.GardenletConfig, r.Clock, r.Namespace, seedIsGarden).CheckSeed(ctx, conditions, r.conditionThresholdsToProgressingMapping())
