...
func (r *Reconciler) newDependencyWatchdogs(seedSettings *gardencorev1beta1.SeedSettings) (dwdWeeder component.DeployWaiter, dwdProber component.DeployWaiter, err error) {
	image, err := imagevector.Containers().FindImage(imagevector.ImageNameDependencyWatchdog, imagevectorutils.RuntimeVersion(r.SeedVersion.String()), imagevectorutils.TargetVersion(r.SeedVersion.String()))
	if err != nil {
		return nil, nil, err
	}
...
func (r *Reconciler) newVPNAuthzServer() (component.DeployWaiter, error) {
	image, err := imagevector.Containers().FindImage(imagevector.ImageNameExtAuthzServer, imagevectorutils.RuntimeVersion(r.SeedVersion.String()), imagevectorutils.TargetVersion(r.SeedVersion.String()))
	if err != nil {
		return nil, err
	}
...
func (r *Reconciler) newSystem(seed *gardencorev1beta1.Seed) (component.DeployWaiter, error) {
	image, err := imagevector.Containers().FindImage(imagevector.ImageNamePauseContainer)
	if err != nil {
		return nil, err
	}
