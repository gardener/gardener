...
func (r *shootReconciler) finalizeShootPrepareForRestoration(ctx context.Context, shoot *gardencorev1beta1.Shoot, o *operation.Operation) (reconcile.Result, error) {
