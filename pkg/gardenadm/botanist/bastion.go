...
func (b *AutonomousBotanist) DefaultBastion() *Bastion {
	return NewBastion(b.Logger, b.SeedClientSet.Client(), b.SecretsManager, &BastionValues{
...
// BastionValues contains the values used to create a Bastion.
type BastionValues struct {
...
// NewBastion creates a new Bastion component with the default clock and wait settings.
func NewBastion(
	log logr.Logger,
	client client.Client,
	secretsManager secretsmanager.Interface,
