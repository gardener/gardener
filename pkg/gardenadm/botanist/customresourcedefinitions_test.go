		...
		When("infrastructure is not managed by Gardener", func() {
			...
			It("should reconcile all expected CRDs", func() {
				...
				Expect(crdList.Items).To(ConsistOf(
					...
					HaveField("ObjectMeta.Name", "authorizationpolicies.security.istio.io"),
					...
					HaveField("ObjectMeta.Name", "destinationrules.networking.istio.io"),
					HaveField("ObjectMeta.Name", "dnsrecords.extensions.gardener.cloud"),
					HaveField("ObjectMeta.Name", "envoyfilters.networking.istio.io"),
					...
					HaveField("ObjectMeta.Name", "gateways.networking.istio.io"),
					...
					HaveField("ObjectMeta.Name", "peerauthentications.security.istio.io"),
					...
					HaveField("ObjectMeta.Name", "proxyconfigs.networking.istio.io"),
					HaveField("ObjectMeta.Name", "requestauthentications.security.istio.io"),
					...
					HaveField("ObjectMeta.Name", "serviceentries.networking.istio.io"),
					HaveField("ObjectMeta.Name", "servicemonitors.monitoring.coreos.com"),
					HaveField("ObjectMeta.Name", "sidecars.networking.istio.io"),
					HaveField("ObjectMeta.Name", "telemetries.telemetry.istio.io"),
					...
					HaveField("ObjectMeta.Name", "virtualservices.networking.istio.io"),
					HaveField("ObjectMeta.Name", "wasmplugins.extensions.istio.io"),
					HaveField("ObjectMeta.Name", "workers.extensions.gardener.cloud"),
					HaveField("ObjectMeta.Name", "workloadentries.networking.istio.io"),
					HaveField("ObjectMeta.Name", "workloadgroups.networking.istio.io"),
				))
			})
		})
