...
// GenerateMachineDeployments creates a slice of extensionsv1alpha1.MachineDeployment using the worker spec present
...
func (s *Shoot) GenerateMachineDeployments() []extensionsv1alpha1.MachineDeployment {
	shoot := s.GetInfo()
	var machineDeployents []extensionsv1alpha1.MachineDeployment
	for _, pool := range shoot.Spec.Provider.Workers {
		...
		if zoneLen == 0 {
			machineDeployents = append(machineDeployents, extensionsv1alpha1.MachineDeployment{
