...
func (b *Botanist) DeployKubeScheduler(ctx context.Context) error {
	b.Shoot.Components.ControlPlane.KubeScheduler.SetSecrets(controlplane.KubeSchedulerSecrets{
		Kubeconfig: controlplane.Secret{Name: "kube-scheduler", Checksum: b.CheckSums[v1beta1constants.DeploymentNameKubeScheduler]},
		Server:     controlplane.Secret{Name: "kube-scheduler-server", Checksum: b.CheckSums[common.KubeSchedulerServerName]},
	})
