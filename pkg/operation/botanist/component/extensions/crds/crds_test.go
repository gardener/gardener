...
var _ = Describe("#CRDs", func() {
	...
	DescribeTable("CRD is deployed",
		...
		Entry("DNSEntry", "dnsentries.dns.gardener.cloud"),
		Entry("DNSOwner", "dnsowners.dns.gardener.cloud"),
		Entry("DNSProvider", "dnsproviders.dns.gardener.cloud"),
		...
		Entry("ManagedResource", "managedresources.resources.gardener.cloud"),
