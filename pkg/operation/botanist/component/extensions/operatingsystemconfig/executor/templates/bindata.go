...
func scriptsExecuteCloudConfigTplSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/execute-cloud-config.tpl.sh", size: 5749, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
