...
// Source: github.com/gardener/gardener/pkg/operation/botanist/component/konnectivity (interfaces: Interface)
...
func (m *MockInterface) SetSecrets(arg0 konnectivity.ServerSecrets) {
	m.ctrl.T.Helper()
