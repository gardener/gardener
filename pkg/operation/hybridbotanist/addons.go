...
func (b *HybridBotanist) generateCoreAddonsChart() (*chartrenderer.RenderedChart, error) {
	...
	return b.ChartApplierShoot.Renderer.Render(filepath.Join(common.ChartPath, "shoot-core"), "shoot-core", metav1.NamespaceSystem, map[string]interface{}{
		"global":              global,
...
func (b *HybridBotanist) generateOptionalAddonsChart() (*chartrenderer.RenderedChart, error) {
	...
	return b.ChartApplierShoot.Renderer.Render(filepath.Join(common.ChartPath, "shoot-addons"), "addons", metav1.NamespaceSystem, map[string]interface{}{
		"kube-lego":            kubeLego,
		"kube2iam":             kube2IAM,
...
func (b *HybridBotanist) generateStorageClassesChart() (*chartrenderer.RenderedChart, error) {
	...
	return b.ChartApplierShoot.Renderer.Render(filepath.Join(common.ChartPath, "shoot-storageclasses"), "storageclasses", metav1.NamespaceSystem, config)
}
