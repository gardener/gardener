...
func NewConfigurator(namespace string, config *schedulerv20v1beta1.KubeSchedulerConfiguration) (configurator.Configurator, error) {
...
func (c *v20Configurator) Config() (string, string, error) {
