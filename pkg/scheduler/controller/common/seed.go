...
func VerifySeedReadiness(seed *gardencorev1beta1.Seed) bool {
	...
	if cond := gardencorev1beta1helper.GetCondition(seed.Status.Conditions, gardencorev1beta1.SeedSystemComponentsHealthy); cond == nil || cond.Status != gardencorev1beta1.ConditionTrue {
		return false
	}
