...
type Values struct {
	...
	// NodeAgentAuthorizerMachineNamespace is the namespace in the source cluster in which the Machine objects are stored.
	NodeAgentAuthorizerMachineNamespace *string
	...
	config := &resourcemanagerconfigv1alpha1.ResourceManagerConfiguration{
		...
		Webhooks: resourcemanagerconfigv1alpha1.ResourceManagerWebhookConfiguration{
			...
			NodeAgentAuthorizer: resourcemanagerconfigv1alpha1.NodeAgentAuthorizerWebhookConfig{
				...
				MachineNamespace:       r.values.NodeAgentAuthorizerMachineNamespace,
			},
