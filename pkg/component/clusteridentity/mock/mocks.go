...
// Source: github.com/gardener/gardener/pkg/component/clusteridentity (interfaces: Interface)
//
// Generated by this command:
//
//	mockgen -package mock -destination=mocks.go github.com/gardener/gardener/pkg/component/clusteridentity Interface
//
...
func (m *MockInterface) SetIdentity(arg0 string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetIdentity", arg0)
}

// SetIdentity indicates an expected call of SetIdentity.
func (mr *MockInterfaceMockRecorder) SetIdentity(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetIdentity", reflect.TypeOf((*MockInterface)(nil).SetIdentity), arg0)
}
