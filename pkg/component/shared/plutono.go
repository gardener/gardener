...
func NewPlutono(
	...
	gardenletManagesMCM, includeIstioDashboards, isAuthenticationWebhookEnabled, isWorkerless bool,
	...
	return plutono.New(
		...
		plutono.Values{
			...
			IsAuthenticationWebhookEnabled: isAuthenticationWebhookEnabled,
