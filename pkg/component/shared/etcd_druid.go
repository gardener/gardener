...
func NewEtcdDruid(
	...
	image, err := imagevector.Containers().FindImage(imagevector.ImageNameEtcdDruid, imagevectorutils.RuntimeVersion(runtimeVersion.String()), imagevectorutils.TargetVersion(runtimeVersion.String()))
	if err != nil {
		return nil, err
	}
