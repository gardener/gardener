			...
			Pools: []extensionsv1alpha1.WorkerPool{
				{
					...
					Labels: utils.MergeStringMaps(worker1Labels, map[string]string{
						...
						"worker.gardener.cloud/cloud-config-key": operatingsystemconfig.Key(worker1Name, kubernetesVersion, &gardencorev1beta1.CRI{Name: worker1CRIName}, nil),
				...
				},
				{
					...
					Labels: map[string]string{
						...
						"networking.gardener.cloud/node-local-dns-enabled": "false",
						"worker.gardener.cloud/cloud-config-key":           operatingsystemconfig.Key(worker2Name, semver.MustParse(workerKubernetesVersion), nil, nil),
					},
