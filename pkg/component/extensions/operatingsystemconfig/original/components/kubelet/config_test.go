...
var _ = Describe("Config", func() {
	var (
		...
		params              = components.ConfigurableKubeletConfigParameters{
			ContainerLogMaxSize:                    new("123Mi"),
			CpuCFSQuota:                            new(false),
			CpuManagerPolicy:                       new("policy"),
			...
			EvictionMaxPodGracePeriod:              new(int32(120)),
		...
		kubeletConfigWithParams = &kubeletconfigv1beta1.KubeletConfiguration{
			...
			ImagePullCredentialsVerificationPolicy: *params.ImagePullCredentialsVerificationPolicy,
			PreloadedImagesVerificationAllowlist:   params.PreloadedImagesVerificationAllowlist,
			ServerTLSBootstrap:                     true,
