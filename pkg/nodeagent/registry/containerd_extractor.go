...
func (e *containerdExtractor) CopyFromImage(ctx context.Context, imageRef string, filePathInImage string, destination string, permissions os.FileMode, configFile *configfile.ConfigFile) error {
	...
	if configFile != nil {
		if userName, password, err := imagevectorutils.CredentialsFromDockerConfigFile(configFile, imageRef); err != nil {
