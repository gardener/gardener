...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodZoneAffinityWebhookConfig) DeepCopyInto(out *PodZoneAffinityWebhookConfig) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodZoneAffinityWebhookConfig.
func (in *PodZoneAffinityWebhookConfig) DeepCopy() *PodZoneAffinityWebhookConfig {
	if in == nil {
		return nil
	}
	out := new(PodZoneAffinityWebhookConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceManagerWebhookConfiguration) DeepCopyInto(out *ResourceManagerWebhookConfiguration) {
	*out = *in
	...
	out.PodZoneAffinity = in.PodZoneAffinity
