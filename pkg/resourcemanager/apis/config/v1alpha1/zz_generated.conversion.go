...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*IngressControllerPeer)(nil), (*config.IngressControllerPeer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_IngressControllerPeer_To_config_IngressControllerPeer(a.(*IngressControllerPeer), b.(*config.IngressControllerPeer), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.IngressControllerPeer)(nil), (*IngressControllerPeer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_IngressControllerPeer_To_v1alpha1_IngressControllerPeer(a.(*config.IngressControllerPeer), b.(*IngressControllerPeer), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_IngressControllerPeer_To_config_IngressControllerPeer(in *IngressControllerPeer, out *config.IngressControllerPeer, s conversion.Scope) error {
	out.Namespace = in.Namespace
	out.PodSelector = in.PodSelector
	return nil
}

// Convert_v1alpha1_IngressControllerPeer_To_config_IngressControllerPeer is an autogenerated conversion function.
func Convert_v1alpha1_IngressControllerPeer_To_config_IngressControllerPeer(in *IngressControllerPeer, out *config.IngressControllerPeer, s conversion.Scope) error {
	return autoConvert_v1alpha1_IngressControllerPeer_To_config_IngressControllerPeer(in, out, s)
}

func autoConvert_config_IngressControllerPeer_To_v1alpha1_IngressControllerPeer(in *config.IngressControllerPeer, out *IngressControllerPeer, s conversion.Scope) error {
	out.Namespace = in.Namespace
	out.PodSelector = in.PodSelector
	return nil
}

// Convert_config_IngressControllerPeer_To_v1alpha1_IngressControllerPeer is an autogenerated conversion function.
func Convert_config_IngressControllerPeer_To_v1alpha1_IngressControllerPeer(in *config.IngressControllerPeer, out *IngressControllerPeer, s conversion.Scope) error {
	return autoConvert_config_IngressControllerPeer_To_v1alpha1_IngressControllerPeer(in, out, s)
}
...
func autoConvert_v1alpha1_NetworkPolicyControllerConfig_To_config_NetworkPolicyControllerConfig(in *NetworkPolicyControllerConfig, out *config.NetworkPolicyControllerConfig, s conversion.Scope) error {
	...
	out.IngressControllerPeer = (*config.IngressControllerPeer)(unsafe.Pointer(in.IngressControllerPeer))
	return nil
}
...
func autoConvert_config_NetworkPolicyControllerConfig_To_v1alpha1_NetworkPolicyControllerConfig(in *config.NetworkPolicyControllerConfig, out *NetworkPolicyControllerConfig, s conversion.Scope) error {
	...
	out.ConcurrentSyncs = (*int)(unsafe.Pointer(in.ConcurrentSyncs))
	out.NamespaceSelectors = *(*[]v1.LabelSelector)(unsafe.Pointer(&in.NamespaceSelectors))
	out.IngressControllerPeer = (*IngressControllerPeer)(unsafe.Pointer(in.IngressControllerPeer))
	return nil
}
