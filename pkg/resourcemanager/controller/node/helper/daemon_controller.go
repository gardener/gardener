...
// Copied from https://github.com/kubernetes/kubernetes/blob/v1.26.0/pkg/controller/daemon/util/daemonset_util.go#L47-L102
...
// Copied from https://github.com/kubernetes/kubernetes/blob/v1.26.0/pkg/apis/core/helper/helpers.go#L92-L114
