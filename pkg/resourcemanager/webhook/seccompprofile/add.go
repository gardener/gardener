...
func (o *WebhookOptions) AddFlags(fs *pflag.FlagSet) {
	fs.BoolVar(&o.enabled, "seccomp-profile-webhook-enabled", false, "enables the seccomp profile webhook")
}
