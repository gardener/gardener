...
type BackupInfrastructureInformer interface {
	...
	Lister() v1alpha1.BackupInfrastructureLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExtensionsV1alpha1().BackupInfrastructures(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExtensionsV1alpha1().BackupInfrastructures(namespace).Watch(options)
			},
		},
		&extensionsv1alpha1.BackupInfrastructure{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backupInfrastructureInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&extensionsv1alpha1.BackupInfrastructure{}, f.defaultInformer)
}

func (f *backupInfrastructureInformer) Lister() v1alpha1.BackupInfrastructureLister {
	return v1alpha1.NewBackupInfrastructureLister(f.Informer().GetIndexer())
}
