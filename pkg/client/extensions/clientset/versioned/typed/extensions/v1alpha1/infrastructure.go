...
func (c *infrastructures) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Infrastructure, err error) {
...
func (c *infrastructures) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InfrastructureList, err error) {
...
func (c *infrastructures) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *infrastructures) Create(ctx context.Context, infrastructure *v1alpha1.Infrastructure, opts v1.CreateOptions) (result *v1alpha1.Infrastructure, err error) {
	result = &v1alpha1.Infrastructure{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("infrastructures").
...
func (c *infrastructures) Update(ctx context.Context, infrastructure *v1alpha1.Infrastructure, opts v1.UpdateOptions) (result *v1alpha1.Infrastructure, err error) {
	result = &v1alpha1.Infrastructure{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("infrastructures").
...
func (c *infrastructures) UpdateStatus(ctx context.Context, infrastructure *v1alpha1.Infrastructure, opts v1.UpdateOptions) (result *v1alpha1.Infrastructure, err error) {
	result = &v1alpha1.Infrastructure{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("infrastructures").
...
func (c *infrastructures) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *infrastructures) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *infrastructures) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Infrastructure, err error) {
	result = &v1alpha1.Infrastructure{}
