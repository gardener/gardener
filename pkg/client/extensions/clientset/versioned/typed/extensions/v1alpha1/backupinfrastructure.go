...
type BackupInfrastructureInterface interface {
	Create(*v1alpha1.BackupInfrastructure) (*v1alpha1.BackupInfrastructure, error)
	Update(*v1alpha1.BackupInfrastructure) (*v1alpha1.BackupInfrastructure, error)
	UpdateStatus(*v1alpha1.BackupInfrastructure) (*v1alpha1.BackupInfrastructure, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.BackupInfrastructure, error)
	List(opts v1.ListOptions) (*v1alpha1.BackupInfrastructureList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.BackupInfrastructure, err error)
...
func newBackupInfrastructures(c *ExtensionsV1alpha1Client, namespace string) *backupInfrastructures {
...
func (c *backupInfrastructures) Get(name string, options v1.GetOptions) (result *v1alpha1.BackupInfrastructure, err error) {
	result = &v1alpha1.BackupInfrastructure{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *backupInfrastructures) List(opts v1.ListOptions) (result *v1alpha1.BackupInfrastructureList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BackupInfrastructureList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("backupinfrastructures").
...
func (c *backupInfrastructures) Create(backupInfrastructure *v1alpha1.BackupInfrastructure) (result *v1alpha1.BackupInfrastructure, err error) {
	result = &v1alpha1.BackupInfrastructure{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("backupinfrastructures").
...
func (c *backupInfrastructures) Update(backupInfrastructure *v1alpha1.BackupInfrastructure) (result *v1alpha1.BackupInfrastructure, err error) {
	result = &v1alpha1.BackupInfrastructure{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backupinfrastructures").
...
func (c *backupInfrastructures) UpdateStatus(backupInfrastructure *v1alpha1.BackupInfrastructure) (result *v1alpha1.BackupInfrastructure, err error) {
	result = &v1alpha1.BackupInfrastructure{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backupinfrastructures").
...
func (c *backupInfrastructures) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.BackupInfrastructure, err error) {
	result = &v1alpha1.BackupInfrastructure{}
