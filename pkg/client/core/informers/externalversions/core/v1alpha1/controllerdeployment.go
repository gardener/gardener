...
type ControllerDeploymentInformer interface {
	...
	Lister() v1alpha1.ControllerDeploymentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha1().ControllerDeployments().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha1().ControllerDeployments().Watch(context.TODO(), options)
			},
		},
		&corev1alpha1.ControllerDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *controllerDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha1.ControllerDeployment{}, f.defaultInformer)
}

func (f *controllerDeploymentInformer) Lister() v1alpha1.ControllerDeploymentLister {
	return v1alpha1.NewControllerDeploymentLister(f.Informer().GetIndexer())
}
