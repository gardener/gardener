...
type ExposureClassInformer interface {
	...
	Lister() v1alpha1.ExposureClassLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha1().ExposureClasses().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha1().ExposureClasses().Watch(context.TODO(), options)
			},
		},
		&corev1alpha1.ExposureClass{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *exposureClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha1.ExposureClass{}, f.defaultInformer)
}

func (f *exposureClassInformer) Lister() v1alpha1.ExposureClassLister {
	return v1alpha1.NewExposureClassLister(f.Informer().GetIndexer())
}
