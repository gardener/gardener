...
type ProjectIndexInformer cache.TypedSharedIndexInformer[*apiscorev1beta1.Project]

// ProjectHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for Project.
type ProjectHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiscorev1beta1.Project]

// ProjectDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for Project.
type ProjectDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiscorev1beta1.Project]

// ProjectFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for Project.
type ProjectFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiscorev1beta1.Project]

// ProjectIndexers is a specialization of [cache.TypedIndexers] for Project.
type ProjectIndexers = cache.TypedIndexers[*apiscorev1beta1.Project]

// DeletedProject is a specialization of [cache.DeletedObject] for Project.
type DeletedProject = cache.DeletedObject[*apiscorev1beta1.Project]
...
func NewTypedProjectInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) ProjectIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiscorev1beta1.Project](cache.NewSharedIndexInformerWithOptions(
...
func (f *projectInformer) TypedInformer() ProjectIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiscorev1beta1.Project](f.factory.InformerFor(&apiscorev1beta1.Project{}, f.defaultInformer))
}
...
func (a *projectTypedInformerAdapter) TypedInformer() ProjectIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiscorev1beta1.Project](a.Informer())
}
...
func ToProjectIndexInformer(informer cache.SharedIndexInformer) ProjectIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiscorev1beta1.Project](informer)
}
