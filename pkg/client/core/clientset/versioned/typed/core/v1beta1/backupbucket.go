...
func (c *backupBuckets) Get(name string, options v1.GetOptions) (result *v1beta1.BackupBucket, err error) {
...
func (c *backupBuckets) List(opts v1.ListOptions) (result *v1beta1.BackupBucketList, err error) {
...
func (c *backupBuckets) Create(backupBucket *v1beta1.BackupBucket) (result *v1beta1.BackupBucket, err error) {
	result = &v1beta1.BackupBucket{}
	err = c.client.Post().
		Resource("backupbuckets").
		Body(backupBucket).
...
func (c *backupBuckets) Update(backupBucket *v1beta1.BackupBucket) (result *v1beta1.BackupBucket, err error) {
	result = &v1beta1.BackupBucket{}
	err = c.client.Put().
		Resource("backupbuckets").
...
func (c *backupBuckets) UpdateStatus(backupBucket *v1beta1.BackupBucket) (result *v1beta1.BackupBucket, err error) {
	result = &v1beta1.BackupBucket{}
	err = c.client.Put().
		Resource("backupbuckets").
		Name(backupBucket.Name).
...
func (c *backupBuckets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.BackupBucket, err error) {
	result = &v1beta1.BackupBucket{}
