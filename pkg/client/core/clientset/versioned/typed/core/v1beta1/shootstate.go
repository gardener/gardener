...
func (c *shootStates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ShootState, err error) {
	result = &v1beta1.ShootState{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *shootStates) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ShootStateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ShootStateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("shootstates").
...
func (c *shootStates) Create(ctx context.Context, shootState *v1beta1.ShootState, opts v1.CreateOptions) (result *v1beta1.ShootState, err error) {
	result = &v1beta1.ShootState{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("shootstates").
...
func (c *shootStates) Update(ctx context.Context, shootState *v1beta1.ShootState, opts v1.UpdateOptions) (result *v1beta1.ShootState, err error) {
	result = &v1beta1.ShootState{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shootstates").
...
func (c *shootStates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ShootState, err error) {
	result = &v1beta1.ShootState{}
