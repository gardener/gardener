...
func (c *plants) Get(name string, options v1.GetOptions) (result *v1beta1.Plant, err error) {
...
func (c *plants) List(opts v1.ListOptions) (result *v1beta1.PlantList, err error) {
...
func (c *plants) Create(plant *v1beta1.Plant) (result *v1beta1.Plant, err error) {
	result = &v1beta1.Plant{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("plants").
...
func (c *plants) Update(plant *v1beta1.Plant) (result *v1beta1.Plant, err error) {
	result = &v1beta1.Plant{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("plants").
...
func (c *plants) UpdateStatus(plant *v1beta1.Plant) (result *v1beta1.Plant, err error) {
	result = &v1beta1.Plant{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("plants").
...
func (c *plants) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Plant, err error) {
	result = &v1beta1.Plant{}
