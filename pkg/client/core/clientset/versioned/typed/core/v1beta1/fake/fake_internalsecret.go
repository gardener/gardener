...
var internalsecretsResource = schema.GroupVersionResource{Group: "core.gardener.cloud", Version: "v1beta1", Resource: "internalsecrets"}

var internalsecretsKind = schema.GroupVersionKind{Group: "core.gardener.cloud", Version: "v1beta1", Kind: "InternalSecret"}
...
func (c *FakeInternalSecrets) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.InternalSecretList, err error) {
	...
	list := &v1beta1.InternalSecretList{ListMeta: obj.(*v1beta1.InternalSecretList).ListMeta}
	for _, item := range obj.(*v1beta1.InternalSecretList).Items {
...
func (c *FakeInternalSecrets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(internalsecretsResource, c.ns, name, opts), &v1beta1.InternalSecret{})
