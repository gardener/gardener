...
func (c *exposureClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ExposureClass, err error) {
	result = &v1beta1.ExposureClass{}
	err = c.client.Get().
...
func (c *exposureClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ExposureClassList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ExposureClassList{}
	err = c.client.Get().
		Resource("exposureclasses").
...
func (c *exposureClasses) Create(ctx context.Context, exposureClass *v1beta1.ExposureClass, opts v1.CreateOptions) (result *v1beta1.ExposureClass, err error) {
	result = &v1beta1.ExposureClass{}
	err = c.client.Post().
		Resource("exposureclasses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *exposureClasses) Update(ctx context.Context, exposureClass *v1beta1.ExposureClass, opts v1.UpdateOptions) (result *v1beta1.ExposureClass, err error) {
	result = &v1beta1.ExposureClass{}
	err = c.client.Put().
		Resource("exposureclasses").
...
func (c *exposureClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ExposureClass, err error) {
	result = &v1beta1.ExposureClass{}
