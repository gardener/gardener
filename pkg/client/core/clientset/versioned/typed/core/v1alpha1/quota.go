...
type QuotaInterface interface {
	Create(*v1alpha1.Quota) (*v1alpha1.Quota, error)
	Update(*v1alpha1.Quota) (*v1alpha1.Quota, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.Quota, error)
	List(opts v1.ListOptions) (*v1alpha1.QuotaList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Quota, err error)
	QuotaExpansion
}
...
func (c *quotas) Get(name string, options v1.GetOptions) (result *v1alpha1.Quota, err error) {
...
func (c *quotas) List(opts v1.ListOptions) (result *v1alpha1.QuotaList, err error) {
...
func (c *quotas) Create(quota *v1alpha1.Quota) (result *v1alpha1.Quota, err error) {
	result = &v1alpha1.Quota{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("quotas").
...
func (c *quotas) Update(quota *v1alpha1.Quota) (result *v1alpha1.Quota, err error) {
	result = &v1alpha1.Quota{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("quotas").
...
func (c *quotas) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Quota, err error) {
	result = &v1alpha1.Quota{}
