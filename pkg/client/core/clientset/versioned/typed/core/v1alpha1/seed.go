...
type SeedInterface interface {
	Create(*v1alpha1.Seed) (*v1alpha1.Seed, error)
	Update(*v1alpha1.Seed) (*v1alpha1.Seed, error)
	UpdateStatus(*v1alpha1.Seed) (*v1alpha1.Seed, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.Seed, error)
	List(opts v1.ListOptions) (*v1alpha1.SeedList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Seed, err error)
	SeedExpansion
}
...
func (c *seeds) Get(name string, options v1.GetOptions) (result *v1alpha1.Seed, err error) {
...
func (c *seeds) List(opts v1.ListOptions) (result *v1alpha1.SeedList, err error) {
...
func (c *seeds) Create(seed *v1alpha1.Seed) (result *v1alpha1.Seed, err error) {
	result = &v1alpha1.Seed{}
	err = c.client.Post().
		Resource("seeds").
		Body(seed).
...
func (c *seeds) Update(seed *v1alpha1.Seed) (result *v1alpha1.Seed, err error) {
	result = &v1alpha1.Seed{}
	err = c.client.Put().
		Resource("seeds").
		Name(seed.Name).
...
func (c *seeds) UpdateStatus(seed *v1alpha1.Seed) (result *v1alpha1.Seed, err error) {
	result = &v1alpha1.Seed{}
	err = c.client.Put().
		Resource("seeds").
		Name(seed.Name).
...
func (c *seeds) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Seed, err error) {
	result = &v1alpha1.Seed{}
