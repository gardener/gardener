...
type CloudProfileInterface interface {
	Create(*v1alpha1.CloudProfile) (*v1alpha1.CloudProfile, error)
	Update(*v1alpha1.CloudProfile) (*v1alpha1.CloudProfile, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.CloudProfile, error)
	List(opts v1.ListOptions) (*v1alpha1.CloudProfileList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CloudProfile, err error)
...
func (c *cloudProfiles) Get(name string, options v1.GetOptions) (result *v1alpha1.CloudProfile, err error) {
...
func (c *cloudProfiles) List(opts v1.ListOptions) (result *v1alpha1.CloudProfileList, err error) {
...
func (c *cloudProfiles) Create(cloudProfile *v1alpha1.CloudProfile) (result *v1alpha1.CloudProfile, err error) {
	result = &v1alpha1.CloudProfile{}
	err = c.client.Post().
		Resource("cloudprofiles").
		Body(cloudProfile).
...
func (c *cloudProfiles) Update(cloudProfile *v1alpha1.CloudProfile) (result *v1alpha1.CloudProfile, err error) {
	result = &v1alpha1.CloudProfile{}
	err = c.client.Put().
		Resource("cloudprofiles").
...
func (c *cloudProfiles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CloudProfile, err error) {
	result = &v1alpha1.CloudProfile{}
