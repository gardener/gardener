...
type SecretBindingInterface interface {
	Create(*v1alpha1.SecretBinding) (*v1alpha1.SecretBinding, error)
	Update(*v1alpha1.SecretBinding) (*v1alpha1.SecretBinding, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SecretBinding, error)
	List(opts v1.ListOptions) (*v1alpha1.SecretBindingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SecretBinding, err error)
...
func (c *secretBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.SecretBinding, err error) {
...
func (c *secretBindings) List(opts v1.ListOptions) (result *v1alpha1.SecretBindingList, err error) {
...
func (c *secretBindings) Create(secretBinding *v1alpha1.SecretBinding) (result *v1alpha1.SecretBinding, err error) {
	result = &v1alpha1.SecretBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("secretbindings").
...
func (c *secretBindings) Update(secretBinding *v1alpha1.SecretBinding) (result *v1alpha1.SecretBinding, err error) {
	result = &v1alpha1.SecretBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("secretbindings").
...
func (c *secretBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SecretBinding, err error) {
	result = &v1alpha1.SecretBinding{}
