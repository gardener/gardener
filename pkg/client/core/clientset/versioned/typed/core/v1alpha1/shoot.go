...
type ShootInterface interface {
	...
	CreateBinding(ctx context.Context, shootName string, binding *v1alpha1.Binding, opts v1.CreateOptions) (*v1.Status, error)
...
func (c *shoots) CreateBinding(ctx context.Context, shootName string, binding *v1alpha1.Binding, opts v1.CreateOptions) (result *v1.Status, err error) {
	result = &v1.Status{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("shoots").
