...
func (c *controllerDeployments) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ControllerDeployment, err error) {
	result = &v1.ControllerDeployment{}
	err = c.client.Get().
...
func (c *controllerDeployments) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ControllerDeploymentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ControllerDeploymentList{}
	err = c.client.Get().
		Resource("controllerdeployments").
...
func (c *controllerDeployments) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *controllerDeployments) Create(ctx context.Context, controllerDeployment *v1.ControllerDeployment, opts metav1.CreateOptions) (result *v1.ControllerDeployment, err error) {
	result = &v1.ControllerDeployment{}
	err = c.client.Post().
		Resource("controllerdeployments").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *controllerDeployments) Update(ctx context.Context, controllerDeployment *v1.ControllerDeployment, opts metav1.UpdateOptions) (result *v1.ControllerDeployment, err error) {
	result = &v1.ControllerDeployment{}
	err = c.client.Put().
		Resource("controllerdeployments").
...
func (c *controllerDeployments) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *controllerDeployments) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *controllerDeployments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ControllerDeployment, err error) {
	result = &v1.ControllerDeployment{}
