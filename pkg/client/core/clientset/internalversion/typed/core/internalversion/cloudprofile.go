...
func (c *cloudProfiles) Get(name string, options v1.GetOptions) (result *core.CloudProfile, err error) {
...
func (c *cloudProfiles) List(opts v1.ListOptions) (result *core.CloudProfileList, err error) {
...
func (c *cloudProfiles) Create(cloudProfile *core.CloudProfile) (result *core.CloudProfile, err error) {
	result = &core.CloudProfile{}
	err = c.client.Post().
		Resource("cloudprofiles").
		Body(cloudProfile).
...
func (c *cloudProfiles) Update(cloudProfile *core.CloudProfile) (result *core.CloudProfile, err error) {
	result = &core.CloudProfile{}
	err = c.client.Put().
		Resource("cloudprofiles").
...
func (c *cloudProfiles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *core.CloudProfile, err error) {
	result = &core.CloudProfile{}
