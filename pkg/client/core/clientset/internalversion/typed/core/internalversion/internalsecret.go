...
type InternalSecretInterface interface {
	Create(ctx context.Context, internalSecret *core.InternalSecret, opts v1.CreateOptions) (*core.InternalSecret, error)
	Update(ctx context.Context, internalSecret *core.InternalSecret, opts v1.UpdateOptions) (*core.InternalSecret, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*core.InternalSecret, error)
	List(ctx context.Context, opts v1.ListOptions) (*core.InternalSecretList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *core.InternalSecret, err error)
...
func newInternalSecrets(c *CoreClient, namespace string) *internalSecrets {
...
func (c *internalSecrets) Get(ctx context.Context, name string, options v1.GetOptions) (result *core.InternalSecret, err error) {
	result = &core.InternalSecret{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *internalSecrets) List(ctx context.Context, opts v1.ListOptions) (result *core.InternalSecretList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &core.InternalSecretList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("internalsecrets").
...
func (c *internalSecrets) Create(ctx context.Context, internalSecret *core.InternalSecret, opts v1.CreateOptions) (result *core.InternalSecret, err error) {
	result = &core.InternalSecret{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("internalsecrets").
...
func (c *internalSecrets) Update(ctx context.Context, internalSecret *core.InternalSecret, opts v1.UpdateOptions) (result *core.InternalSecret, err error) {
	result = &core.InternalSecret{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("internalsecrets").
...
func (c *internalSecrets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *core.InternalSecret, err error) {
	result = &core.InternalSecret{}
