...
func (c *shoots) Get(name string, options v1.GetOptions) (result *core.Shoot, err error) {
	result = &core.Shoot{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("shoots").
...
func (c *shoots) List(opts v1.ListOptions) (result *core.ShootList, err error) {
...
func (c *shoots) Create(shoot *core.Shoot) (result *core.Shoot, err error) {
	result = &core.Shoot{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("shoots").
...
func (c *shoots) Update(shoot *core.Shoot) (result *core.Shoot, err error) {
	result = &core.Shoot{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shoots").
...
func (c *shoots) UpdateStatus(shoot *core.Shoot) (result *core.Shoot, err error) {
	result = &core.Shoot{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shoots").
...
func (c *shoots) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *core.Shoot, err error) {
	result = &core.Shoot{}
