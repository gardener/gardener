...
type ShootExtensionStatusInterface interface {
	Create(ctx context.Context, shootExtensionStatus *core.ShootExtensionStatus, opts v1.CreateOptions) (*core.ShootExtensionStatus, error)
	Update(ctx context.Context, shootExtensionStatus *core.ShootExtensionStatus, opts v1.UpdateOptions) (*core.ShootExtensionStatus, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*core.ShootExtensionStatus, error)
	List(ctx context.Context, opts v1.ListOptions) (*core.ShootExtensionStatusList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *core.ShootExtensionStatus, err error)
...
func newShootExtensionStatuses(c *CoreClient, namespace string) *shootExtensionStatuses {
...
func (c *shootExtensionStatuses) Get(ctx context.Context, name string, options v1.GetOptions) (result *core.ShootExtensionStatus, err error) {
	result = &core.ShootExtensionStatus{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *shootExtensionStatuses) List(ctx context.Context, opts v1.ListOptions) (result *core.ShootExtensionStatusList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &core.ShootExtensionStatusList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("shootextensionstatuses").
...
func (c *shootExtensionStatuses) Create(ctx context.Context, shootExtensionStatus *core.ShootExtensionStatus, opts v1.CreateOptions) (result *core.ShootExtensionStatus, err error) {
	result = &core.ShootExtensionStatus{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("shootextensionstatuses").
...
func (c *shootExtensionStatuses) Update(ctx context.Context, shootExtensionStatus *core.ShootExtensionStatus, opts v1.UpdateOptions) (result *core.ShootExtensionStatus, err error) {
	result = &core.ShootExtensionStatus{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shootextensionstatuses").
...
func (c *shootExtensionStatuses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *core.ShootExtensionStatus, err error) {
	result = &core.ShootExtensionStatus{}
