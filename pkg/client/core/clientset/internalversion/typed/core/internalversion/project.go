...
func (c *projects) Get(name string, options v1.GetOptions) (result *core.Project, err error) {
	result = &core.Project{}
	err = c.client.Get().
		Resource("projects").
		Name(name).
...
func (c *projects) List(opts v1.ListOptions) (result *core.ProjectList, err error) {
...
func (c *projects) Create(project *core.Project) (result *core.Project, err error) {
	result = &core.Project{}
	err = c.client.Post().
		Resource("projects").
		Body(project).
...
func (c *projects) Update(project *core.Project) (result *core.Project, err error) {
	result = &core.Project{}
	err = c.client.Put().
		Resource("projects").
		Name(project.Name).
...
func (c *projects) UpdateStatus(project *core.Project) (result *core.Project, err error) {
	result = &core.Project{}
	err = c.client.Put().
		Resource("projects").
		Name(project.Name).
...
func (c *projects) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *core.Project, err error) {
	result = &core.Project{}
