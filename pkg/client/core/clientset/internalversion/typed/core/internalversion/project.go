...
func (c *projects) Get(ctx context.Context, name string, options v1.GetOptions) (result *core.Project, err error) {
	result = &core.Project{}
	err = c.client.Get().
		Resource("projects").
		Name(name).
...
func (c *projects) List(ctx context.Context, opts v1.ListOptions) (result *core.ProjectList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &core.ProjectList{}
	err = c.client.Get().
		Resource("projects").
...
func (c *projects) Create(ctx context.Context, project *core.Project, opts v1.CreateOptions) (result *core.Project, err error) {
	result = &core.Project{}
	err = c.client.Post().
		Resource("projects").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *projects) Update(ctx context.Context, project *core.Project, opts v1.UpdateOptions) (result *core.Project, err error) {
	result = &core.Project{}
	err = c.client.Put().
		Resource("projects").
		Name(project.Name).
...
func (c *projects) UpdateStatus(ctx context.Context, project *core.Project, opts v1.UpdateOptions) (result *core.Project, err error) {
	result = &core.Project{}
	err = c.client.Put().
		Resource("projects").
		Name(project.Name).
...
func (c *projects) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *core.Project, err error) {
	result = &core.Project{}
