	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GardenV1beta1().CrossSecretBindings(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GardenV1beta1().CrossSecretBindings(namespace).Watch(options)
			},
		},
		&garden_v1beta1.CrossSecretBinding{},
		resyncPeriod,
		indexers,
	)
}

func (f *crossSecretBindingInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *crossSecretBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&garden_v1beta1.CrossSecretBinding{}, f.defaultInformer)
}

func (f *crossSecretBindingInformer) Lister() v1beta1.CrossSecretBindingLister {
	return v1beta1.NewCrossSecretBindingLister(f.Informer().GetIndexer())
}
