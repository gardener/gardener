...
import (
	...
	versioned "github.com/gardener/gardener/pkg/client/authentication/clientset/versioned"
	internalinterfaces "github.com/gardener/gardener/pkg/client/authentication/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/gardener/gardener/pkg/client/authentication/listers/authentication/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AuthenticationV1alpha1().CredentialsBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AuthenticationV1alpha1().CredentialsBindings(namespace).Watch(context.TODO(), options)
			},
		},
		&authenticationv1alpha1.CredentialsBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *credentialsBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&authenticationv1alpha1.CredentialsBinding{}, f.defaultInformer)
}
