...
import (
	...
	"github.com/gardener/gardener/pkg/client/authentication/clientset/versioned/scheme"
...
// AuthenticationV1alpha1Client is used to interact with features provided by the authentication.gardener.cloud group.
type AuthenticationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AuthenticationV1alpha1Client) CredentialsBindings(namespace string) CredentialsBindingInterface {
