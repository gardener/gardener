...
type OpenIDConnectPresetInterface interface {
	Create(*v1alpha1.OpenIDConnectPreset) (*v1alpha1.OpenIDConnectPreset, error)
	Update(*v1alpha1.OpenIDConnectPreset) (*v1alpha1.OpenIDConnectPreset, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.OpenIDConnectPreset, error)
	List(opts v1.ListOptions) (*v1alpha1.OpenIDConnectPresetList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.OpenIDConnectPreset, err error)
...
func (c *openIDConnectPresets) Get(name string, options v1.GetOptions) (result *v1alpha1.OpenIDConnectPreset, err error) {
...
func (c *openIDConnectPresets) List(opts v1.ListOptions) (result *v1alpha1.OpenIDConnectPresetList, err error) {
...
func (c *openIDConnectPresets) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *openIDConnectPresets) Create(openIDConnectPreset *v1alpha1.OpenIDConnectPreset) (result *v1alpha1.OpenIDConnectPreset, err error) {
	result = &v1alpha1.OpenIDConnectPreset{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("openidconnectpresets").
...
func (c *openIDConnectPresets) Update(openIDConnectPreset *v1alpha1.OpenIDConnectPreset) (result *v1alpha1.OpenIDConnectPreset, err error) {
	result = &v1alpha1.OpenIDConnectPreset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("openidconnectpresets").
...
func (c *openIDConnectPresets) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *openIDConnectPresets) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *openIDConnectPresets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.OpenIDConnectPreset, err error) {
	result = &v1alpha1.OpenIDConnectPreset{}
