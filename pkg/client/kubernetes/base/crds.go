...
func (c *Client) crds() apiextensionsclientset.CustomResourceDefinitionInterface {
	return c.apiextensionClientset.ApiextensionsV1beta1().CustomResourceDefinitions()
}
...
func (c *Client) ListCRDs(opts metav1.ListOptions) (*apiextensionsv1beta1.CustomResourceDefinitionList, error) {
	return c.apiextensionClientset.ApiextensionsV1beta1().CustomResourceDefinitions().List(opts)
}
