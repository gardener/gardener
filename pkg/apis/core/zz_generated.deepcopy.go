...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentImageVector) DeepCopyInto(out *ComponentImageVector) {
	*out = *in
	if in.ImageVector != nil {
		in, out := &in.ImageVector, &out.ImageVector
		*out = make(ImageVector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentImageVector.
func (in *ComponentImageVector) DeepCopy() *ComponentImageVector {
	if in == nil {
		return nil
	}
	out := new(ComponentImageVector)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ComponentImageVectors) DeepCopyInto(out *ComponentImageVectors) {
	{
		in := &in
		*out = make(ComponentImageVectors, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentImageVectors.
func (in ComponentImageVectors) DeepCopy() ComponentImageVectors {
	if in == nil {
		return nil
	}
	out := new(ComponentImageVectors)
	in.DeepCopyInto(out)
	return *out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ImageVector) DeepCopyInto(out *ImageVector) {
	{
		in := &in
		*out = make(ImageVector, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImageVector.
func (in ImageVector) DeepCopy() ImageVector {
	if in == nil {
		return nil
	}
	out := new(ImageVector)
