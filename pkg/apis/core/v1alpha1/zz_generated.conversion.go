...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ShootExtensionStatusSpec)(nil), (*core.ShootExtensionStatusSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ShootExtensionStatusSpec_To_core_ShootExtensionStatusSpec(a.(*ShootExtensionStatusSpec), b.(*core.ShootExtensionStatusSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ShootExtensionStatusSpec)(nil), (*ShootExtensionStatusSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ShootExtensionStatusSpec_To_v1alpha1_ShootExtensionStatusSpec(a.(*core.ShootExtensionStatusSpec), b.(*ShootExtensionStatusSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ShootExtensionStatus_To_core_ShootExtensionStatus(in *ShootExtensionStatus, out *core.ShootExtensionStatus, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1alpha1_ShootExtensionStatusSpec_To_core_ShootExtensionStatusSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_core_ShootExtensionStatus_To_v1alpha1_ShootExtensionStatus(in *core.ShootExtensionStatus, out *ShootExtensionStatus, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_core_ShootExtensionStatusSpec_To_v1alpha1_ShootExtensionStatusSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_ShootExtensionStatusSpec_To_core_ShootExtensionStatusSpec(in *ShootExtensionStatusSpec, out *core.ShootExtensionStatusSpec, s conversion.Scope) error {
	if in.Statuses != nil {
...
// Convert_v1alpha1_ShootExtensionStatusSpec_To_core_ShootExtensionStatusSpec is an autogenerated conversion function.
func Convert_v1alpha1_ShootExtensionStatusSpec_To_core_ShootExtensionStatusSpec(in *ShootExtensionStatusSpec, out *core.ShootExtensionStatusSpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_ShootExtensionStatusSpec_To_core_ShootExtensionStatusSpec(in, out, s)
}

func autoConvert_core_ShootExtensionStatusSpec_To_v1alpha1_ShootExtensionStatusSpec(in *core.ShootExtensionStatusSpec, out *ShootExtensionStatusSpec, s conversion.Scope) error {
	if in.Statuses != nil {
		in, out := &in.Statuses, &out.Statuses
...
// Convert_core_ShootExtensionStatusSpec_To_v1alpha1_ShootExtensionStatusSpec is an autogenerated conversion function.
func Convert_core_ShootExtensionStatusSpec_To_v1alpha1_ShootExtensionStatusSpec(in *core.ShootExtensionStatusSpec, out *ShootExtensionStatusSpec, s conversion.Scope) error {
	return autoConvert_core_ShootExtensionStatusSpec_To_v1alpha1_ShootExtensionStatusSpec(in, out, s)
}
