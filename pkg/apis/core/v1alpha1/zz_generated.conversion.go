...
func autoConvert_v1alpha1_PlantSpec_To_core_PlantSpec(in *PlantSpec, out *core.PlantSpec, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_Monitoring_To_core_Monitoring(&in.Monitoring, &out.Monitoring, s); err != nil {
		return err
	}
	if err := Convert_v1alpha1_Logging_To_core_Logging(&in.Logging, &out.Logging, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_core_PlantSpec_To_v1alpha1_PlantSpec(in *core.PlantSpec, out *PlantSpec, s conversion.Scope) error {
	out.SecretRef = in.SecretRef
	if err := Convert_core_Monitoring_To_v1alpha1_Monitoring(&in.Monitoring, &out.Monitoring, s); err != nil {
		return err
	}
	if err := Convert_core_Logging_To_v1alpha1_Logging(&in.Logging, &out.Logging, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_PlantStatus_To_core_PlantStatus(in *PlantStatus, out *core.PlantStatus, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_ClusterInfo_To_core_ClusterInfo(&in.ClusterInfo, &out.ClusterInfo, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_core_PlantStatus_To_v1alpha1_PlantStatus(in *core.PlantStatus, out *PlantStatus, s conversion.Scope) error {
	out.Conditions = *(*[]Condition)(unsafe.Pointer(&in.Conditions))
	out.ObservedGeneration = (*int64)(unsafe.Pointer(in.ObservedGeneration))
	if err := Convert_core_ClusterInfo_To_v1alpha1_ClusterInfo(&in.ClusterInfo, &out.ClusterInfo, s); err != nil {
		return err
	}
	return nil
}
