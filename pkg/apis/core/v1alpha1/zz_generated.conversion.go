...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*DNSRateLimit)(nil), (*core.DNSRateLimit)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_DNSRateLimit_To_core_DNSRateLimit(a.(*DNSRateLimit), b.(*core.DNSRateLimit), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.DNSRateLimit)(nil), (*DNSRateLimit)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_DNSRateLimit_To_v1alpha1_DNSRateLimit(a.(*core.DNSRateLimit), b.(*DNSRateLimit), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_DNSProvider_To_core_DNSProvider(in *DNSProvider, out *core.DNSProvider, s conversion.Scope) error {
	...
	out.RateLimit = (*core.DNSRateLimit)(unsafe.Pointer(in.RateLimit))
	return nil
}
...
func autoConvert_core_DNSProvider_To_v1alpha1_DNSProvider(in *core.DNSProvider, out *DNSProvider, s conversion.Scope) error {
	...
	out.RateLimit = (*DNSRateLimit)(unsafe.Pointer(in.RateLimit))
	return nil
}
...
func autoConvert_v1alpha1_DNSRateLimit_To_core_DNSRateLimit(in *DNSRateLimit, out *core.DNSRateLimit, s conversion.Scope) error {
	out.RequestsPerDay = in.RequestsPerDay
	out.Burst = in.Burst
	return nil
}

// Convert_v1alpha1_DNSRateLimit_To_core_DNSRateLimit is an autogenerated conversion function.
func Convert_v1alpha1_DNSRateLimit_To_core_DNSRateLimit(in *DNSRateLimit, out *core.DNSRateLimit, s conversion.Scope) error {
	return autoConvert_v1alpha1_DNSRateLimit_To_core_DNSRateLimit(in, out, s)
}

func autoConvert_core_DNSRateLimit_To_v1alpha1_DNSRateLimit(in *core.DNSRateLimit, out *DNSRateLimit, s conversion.Scope) error {
	out.RequestsPerDay = in.RequestsPerDay
	out.Burst = in.Burst
	return nil
}

// Convert_core_DNSRateLimit_To_v1alpha1_DNSRateLimit is an autogenerated conversion function.
func Convert_core_DNSRateLimit_To_v1alpha1_DNSRateLimit(in *core.DNSRateLimit, out *DNSRateLimit, s conversion.Scope) error {
	return autoConvert_core_DNSRateLimit_To_v1alpha1_DNSRateLimit(in, out, s)
}
