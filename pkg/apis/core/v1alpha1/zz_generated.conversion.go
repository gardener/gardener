...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ShootControlPlane)(nil), (*core.ShootControlPlane)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ShootControlPlane_To_core_ShootControlPlane(a.(*ShootControlPlane), b.(*core.ShootControlPlane), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ShootControlPlane)(nil), (*ShootControlPlane)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ShootControlPlane_To_v1alpha1_ShootControlPlane(a.(*core.ShootControlPlane), b.(*ShootControlPlane), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_core_FailureTolerance_To_v1alpha1_FailureTolerance(in *core.FailureTolerance, out *FailureTolerance, s conversion.Scope) error {
	out.FailureToleranceType = (*FailureToleranceType)(unsafe.Pointer(in.FailureToleranceType))
	return nil
}
...
func autoConvert_v1alpha1_ShootControlPlane_To_core_ShootControlPlane(in *ShootControlPlane, out *core.ShootControlPlane, s conversion.Scope) error {
	if err := Convert_v1alpha1_HighAvailability_To_core_HighAvailability(&in.HighAvailability, &out.HighAvailability, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha1_ShootControlPlane_To_core_ShootControlPlane is an autogenerated conversion function.
func Convert_v1alpha1_ShootControlPlane_To_core_ShootControlPlane(in *ShootControlPlane, out *core.ShootControlPlane, s conversion.Scope) error {
	return autoConvert_v1alpha1_ShootControlPlane_To_core_ShootControlPlane(in, out, s)
}

func autoConvert_core_ShootControlPlane_To_v1alpha1_ShootControlPlane(in *core.ShootControlPlane, out *ShootControlPlane, s conversion.Scope) error {
	if err := Convert_core_HighAvailability_To_v1alpha1_HighAvailability(&in.HighAvailability, &out.HighAvailability, s); err != nil {
		return err
	}
	return nil
}

// Convert_core_ShootControlPlane_To_v1alpha1_ShootControlPlane is an autogenerated conversion function.
func Convert_core_ShootControlPlane_To_v1alpha1_ShootControlPlane(in *core.ShootControlPlane, out *ShootControlPlane, s conversion.Scope) error {
	return autoConvert_core_ShootControlPlane_To_v1alpha1_ShootControlPlane(in, out, s)
}
...
func autoConvert_v1alpha1_ShootSpec_To_core_ShootSpec(in *ShootSpec, out *core.ShootSpec, s conversion.Scope) error {
	...
	out.ShootControlPlane = (*core.ShootControlPlane)(unsafe.Pointer(in.ShootControlPlane))
	return nil
}
...
func autoConvert_core_ShootSpec_To_v1alpha1_ShootSpec(in *core.ShootSpec, out *ShootSpec, s conversion.Scope) error {
	...
	out.ShootControlPlane = (*ShootControlPlane)(unsafe.Pointer(in.ShootControlPlane))
	return nil
}
