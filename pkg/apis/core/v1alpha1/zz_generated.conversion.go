...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Binding)(nil), (*core.Binding)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Binding_To_core_Binding(a.(*Binding), b.(*core.Binding), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.Binding)(nil), (*Binding)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_Binding_To_v1alpha1_Binding(a.(*core.Binding), b.(*Binding), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Binding_To_core_Binding(in *Binding, out *core.Binding, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Target = in.Target
	return nil
}

// Convert_v1alpha1_Binding_To_core_Binding is an autogenerated conversion function.
func Convert_v1alpha1_Binding_To_core_Binding(in *Binding, out *core.Binding, s conversion.Scope) error {
	return autoConvert_v1alpha1_Binding_To_core_Binding(in, out, s)
}

func autoConvert_core_Binding_To_v1alpha1_Binding(in *core.Binding, out *Binding, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Target = in.Target
	return nil
}

// Convert_core_Binding_To_v1alpha1_Binding is an autogenerated conversion function.
func Convert_core_Binding_To_v1alpha1_Binding(in *core.Binding, out *Binding, s conversion.Scope) error {
	return autoConvert_core_Binding_To_v1alpha1_Binding(in, out, s)
}
