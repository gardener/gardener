...
// +genclient:method=CreateBinding,verb=create,subresource=binding,input=github.com/gardener/gardener/pkg/apis/core/v1alpha1.Binding,result=k8s.io/apimachinery/pkg/apis/meta/v1.Status
