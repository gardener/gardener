...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PendingWorkersUpdate) DeepCopyInto(out *PendingWorkersUpdate) {
	*out = *in
	if in.LastInitiationTimeCertificateAuthoritiesRotation != nil {
		in, out := &in.LastInitiationTimeCertificateAuthoritiesRotation, &out.LastInitiationTimeCertificateAuthoritiesRotation
		*out = (*in).DeepCopy()
	}
	if in.LastInitiationTimeServiceAccountKeyRotation != nil {
		in, out := &in.LastInitiationTimeServiceAccountKeyRotation, &out.LastInitiationTimeServiceAccountKeyRotation
		*out = (*in).DeepCopy()
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PendingWorkersUpdate.
func (in *PendingWorkersUpdate) DeepCopy() *PendingWorkersUpdate {
	if in == nil {
		return nil
	}
	out := new(PendingWorkersUpdate)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ShootStatus) DeepCopyInto(out *ShootStatus) {
	*out = *in
	...
	if in.PendingWorkersUpdates != nil {
		in, out := &in.PendingWorkersUpdates, &out.PendingWorkersUpdates
		*out = make([]PendingWorkersUpdate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
