...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SeedDNSProviderConf) DeepCopyInto(out *SeedDNSProviderConf) {
	*out = *in
	if in.Zone != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SeedDNSProviderConf.
func (in *SeedDNSProviderConf) DeepCopy() *SeedDNSProviderConf {
	if in == nil {
		return nil
	}
	out := new(SeedDNSProviderConf)
