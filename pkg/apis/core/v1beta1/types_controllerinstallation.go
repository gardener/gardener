...
type ControllerInstallationSpec struct {
	...
	// +optional
	DeploymentRef *corev1.ObjectReference `json:"deploymentRef" protobuf:"bytes,1,opt,name=deploymentRef"`
	// RegistrationRef is used to reference a ControllerRegistration resource.
	RegistrationRef corev1.ObjectReference `json:"registrationRef" protobuf:"bytes,2,opt,name=registrationRef"`
	// SeedRef is used to reference a Seed resource.
	SeedRef corev1.ObjectReference `json:"seedRef" protobuf:"bytes,3,opt,name=seedRef"`
}
