...
const (
	...
	// LabelWorkerPoolOperatingSystemConfig is the name of the applied cloud-config secret
	LabelWorkerPoolOperatingSystemConfig = "worker.gardener.cloud/cloud-config-key"
