...
type Kubernetes struct {
	...
	// EnableAdminKubeconfig indicates whether static token kubeconfig secret should be present in garden cluster
	// (default: true).
	// +optional
	EnableAdminKubeconfig *bool `json:"enableAdminKubeconfig,omitempty" protobuf:"varint,10,opt,name=enableAdminKubeconfig"`
}
