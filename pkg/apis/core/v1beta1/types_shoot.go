...
type ShootCredentialsRotation struct {
	...
	// +optional
	//
	// Deprecated: This field is deprecated and will be removed in gardener v1.118
...
type KubeControllerManagerConfig struct {
	...
	// `spec.kubernetes.kubeAPIServer.defaultUnreachableTolerationSeconds`. This field will be removed in gardener v1.118.
