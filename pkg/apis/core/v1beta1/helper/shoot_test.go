...
var _ = Describe("Helper", func() {
	...
	DescribeTable("#GetMinAllowedForKubeAPIServer",
		func(apiServerConfig *gardencorev1beta1.KubeAPIServerConfig, expectation corev1.ResourceList) {
		...
		Entry("no autoscaling configured",
			&gardencorev1beta1.KubeAPIServerConfig{},
			nil,
		),
		Entry("no minAllowed configured",
			&gardencorev1beta1.KubeAPIServerConfig{Autoscaling: &gardencorev1beta1.ControlPlaneAutoscaling{}},
			nil,
		),
	...
	DescribeTable("#GetMinAllowedForETCD{Main,Events}",
		func(etcd *gardencorev1beta1.ETCD, expectationETCDMain, expectationETCDEvents corev1.ResourceList) {
		...
		Entry("no etcd configured (empty)",
			&gardencorev1beta1.ETCD{},
			nil,
			nil,
		),
		Entry("no minAllowed configured",
			&gardencorev1beta1.ETCD{Main: &gardencorev1beta1.ETCDConfig{Autoscaling: &gardencorev1beta1.ControlPlaneAutoscaling{}}},
			nil,
			nil,
		),
		Entry("only etcd events configured",
			&gardencorev1beta1.ETCD{Events: &gardencorev1beta1.ETCDConfig{Autoscaling: &gardencorev1beta1.ControlPlaneAutoscaling{
		...
		Entry("minAllowed configured for etcd main and etcd events",
			&gardencorev1beta1.ETCD{
				Main: &gardencorev1beta1.ETCDConfig{Autoscaling: &gardencorev1beta1.ControlPlaneAutoscaling{
					MinAllowed: corev1.ResourceList{corev1.ResourceCPU: resource.MustParse("100m")},
				}},
				Events: &gardencorev1beta1.ETCDConfig{Autoscaling: &gardencorev1beta1.ControlPlaneAutoscaling{
					MinAllowed: corev1.ResourceList{corev1.ResourceCPU: resource.MustParse("50m")},
				}},
			},
			corev1.ResourceList{corev1.ResourceCPU: resource.MustParse("100m")},
