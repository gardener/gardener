...
var _ = Describe("Helper", func() {
	...
	DescribeTable("#ShootDNSProviderCredentialsRefsEqual",
		func(oldDNS, newDNS *gardencorev1beta1.DNS, matcher gomegatypes.GomegaMatcher) {
			Expect(ShootDNSProviderCredentialsRefsEqual(oldDNS, newDNS)).To(matcher)
		},

		Entry("both nil", nil, nil, BeTrue()),
		Entry("old nil, new w/o credentials references", nil, &gardencorev1beta1.DNS{}, BeTrue()),
		Entry("old w/o credentials references, new nil", &gardencorev1beta1.DNS{}, nil, BeTrue()),
		Entry("[Secret] difference due to old",
			&gardencorev1beta1.DNS{},
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "v1", Kind: "Secret", Name: "foo"}}}},
			BeFalse(),
		),
		Entry("[Secret] difference due to new",
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "v1", Kind: "Secret", Name: "foo"}}}},
			&gardencorev1beta1.DNS{},
			BeFalse(),
		),
		Entry("[Secret] difference due to resource name",
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "v1", Kind: "Secret", Name: "foo"}}}},
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "v1", Kind: "Secret", Name: "bar"}}}},
			BeFalse(),
		),
		Entry("[Secret] equality",
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "v1", Kind: "Secret", Name: "foo"}}}},
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "v1", Kind: "Secret", Name: "foo"}}}},
			BeTrue(),
		),
		Entry("[WorkloadIdentity] difference due to old",
			&gardencorev1beta1.DNS{},
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "security.gardener.cloud/v1alpha1", Kind: "WorkloadIdentity", Name: "foo"}}}},
			BeFalse(),
		),
		Entry("[WorkloadIdentity] difference due to new",
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "security.gardener.cloud/v1alpha1", Kind: "WorkloadIdentity", Name: "foo"}}}},
			&gardencorev1beta1.DNS{},
			BeFalse(),
		),
		Entry("[WorkloadIdentity] difference due to resource name",
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "security.gardener.cloud/v1alpha1", Kind: "WorkloadIdentity", Name: "foo"}}}},
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "security.gardener.cloud/v1alpha1", Kind: "WorkloadIdentity", Name: "bar"}}}},
			BeFalse(),
		),
		Entry("[WorkloadIdentity] equality",
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "security.gardener.cloud/v1alpha1", Kind: "WorkloadIdentity", Name: "foo"}}}},
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "security.gardener.cloud/v1alpha1", Kind: "WorkloadIdentity", Name: "foo"}}}},
			BeTrue(),
		),
		Entry("difference due to old with Secret, new with WorkloadIdentity",
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "v1", Kind: "Secret", Name: "foo"}}}},
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "security.gardener.cloud/v1alpha1", Kind: "WorkloadIdentity", Name: "foo"}}}},
			BeFalse(),
		),
		Entry("difference due to old with WorkloadIdentity, new with Secret",
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "security.gardener.cloud/v1alpha1", Kind: "WorkloadIdentity", Name: "foo"}}}},
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "v1", Kind: "Secret", Name: "foo"}}}},
			BeFalse(),
		),
		Entry("equality with mixed credentialRef types",
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{
				{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "v1", Kind: "Secret", Name: "foo"}},
				{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "security.gardener.cloud/v1alpha1", Kind: "WorkloadIdentity", Name: "foo"}},
			}},
			&gardencorev1beta1.DNS{Providers: []gardencorev1beta1.DNSProvider{
				{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "security.gardener.cloud/v1alpha1", Kind: "WorkloadIdentity", Name: "foo"}},
				{CredentialsRef: &autoscalingv1.CrossVersionObjectReference{APIVersion: "v1", Kind: "Secret", Name: "foo"}},
	...
	DescribeTable("#RemoveOperation",
		func(operations, operationsToRemove, newOperations, expectedResult []string) {
			result := RemoveOperation(operations, operationsToRemove...)

			Expect(operations).To(Equal(newOperations))
