...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ExpanderConfig)(nil), (*core.ExpanderConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ExpanderConfig_To_core_ExpanderConfig(a.(*ExpanderConfig), b.(*core.ExpanderConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ExpanderConfig)(nil), (*ExpanderConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ExpanderConfig_To_v1beta1_ExpanderConfig(a.(*core.ExpanderConfig), b.(*ExpanderConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_ClusterAutoscaler_To_core_ClusterAutoscaler(in *ClusterAutoscaler, out *core.ClusterAutoscaler, s conversion.Scope) error {
	...
	out.ExpanderConfig = (*core.ExpanderConfig)(unsafe.Pointer(in.ExpanderConfig))
...
func autoConvert_core_ClusterAutoscaler_To_v1beta1_ClusterAutoscaler(in *core.ClusterAutoscaler, out *ClusterAutoscaler, s conversion.Scope) error {
	...
	out.ExpanderConfig = (*ExpanderConfig)(unsafe.Pointer(in.ExpanderConfig))
	out.MaxNodeProvisionTime = (*metav1.Duration)(unsafe.Pointer(in.MaxNodeProvisionTime))
	out.MaxGracefulTerminationSeconds = (*int32)(unsafe.Pointer(in.MaxGracefulTerminationSeconds))
	out.IgnoreTaints = *(*[]string)(unsafe.Pointer(&in.IgnoreTaints))
	out.NewPodScaleUpDelay = (*metav1.Duration)(unsafe.Pointer(in.NewPodScaleUpDelay))
...
func autoConvert_v1beta1_ExpanderConfig_To_core_ExpanderConfig(in *ExpanderConfig, out *core.ExpanderConfig, s conversion.Scope) error {
	out.ConfigMapName = (*string)(unsafe.Pointer(in.ConfigMapName))
	return nil
}

// Convert_v1beta1_ExpanderConfig_To_core_ExpanderConfig is an autogenerated conversion function.
func Convert_v1beta1_ExpanderConfig_To_core_ExpanderConfig(in *ExpanderConfig, out *core.ExpanderConfig, s conversion.Scope) error {
	return autoConvert_v1beta1_ExpanderConfig_To_core_ExpanderConfig(in, out, s)
}

func autoConvert_core_ExpanderConfig_To_v1beta1_ExpanderConfig(in *core.ExpanderConfig, out *ExpanderConfig, s conversion.Scope) error {
	out.ConfigMapName = (*string)(unsafe.Pointer(in.ConfigMapName))
	return nil
}

// Convert_core_ExpanderConfig_To_v1beta1_ExpanderConfig is an autogenerated conversion function.
func Convert_core_ExpanderConfig_To_v1beta1_ExpanderConfig(in *core.ExpanderConfig, out *ExpanderConfig, s conversion.Scope) error {
	return autoConvert_core_ExpanderConfig_To_v1beta1_ExpanderConfig(in, out, s)
}
