...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*AccessControl)(nil), (*core.AccessControl)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_AccessControl_To_core_AccessControl(a.(*AccessControl), b.(*core.AccessControl), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.AccessControl)(nil), (*AccessControl)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_AccessControl_To_v1beta1_AccessControl(a.(*core.AccessControl), b.(*AccessControl), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*AuthorizationSource)(nil), (*core.AuthorizationSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_AuthorizationSource_To_core_AuthorizationSource(a.(*AuthorizationSource), b.(*core.AuthorizationSource), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.AuthorizationSource)(nil), (*AuthorizationSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_AuthorizationSource_To_v1beta1_AuthorizationSource(a.(*core.AuthorizationSource), b.(*AuthorizationSource), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_AccessControl_To_core_AccessControl(in *AccessControl, out *core.AccessControl, s conversion.Scope) error {
	out.Action = core.AuthorizationAction(in.Action)
	if err := Convert_v1beta1_AuthorizationSource_To_core_AuthorizationSource(&in.Source, &out.Source, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1beta1_AccessControl_To_core_AccessControl is an autogenerated conversion function.
func Convert_v1beta1_AccessControl_To_core_AccessControl(in *AccessControl, out *core.AccessControl, s conversion.Scope) error {
	return autoConvert_v1beta1_AccessControl_To_core_AccessControl(in, out, s)
}

func autoConvert_core_AccessControl_To_v1beta1_AccessControl(in *core.AccessControl, out *AccessControl, s conversion.Scope) error {
	out.Action = AuthorizationAction(in.Action)
	if err := Convert_core_AuthorizationSource_To_v1beta1_AuthorizationSource(&in.Source, &out.Source, s); err != nil {
		return err
	}
	return nil
}

// Convert_core_AccessControl_To_v1beta1_AccessControl is an autogenerated conversion function.
func Convert_core_AccessControl_To_v1beta1_AccessControl(in *core.AccessControl, out *AccessControl, s conversion.Scope) error {
	return autoConvert_core_AccessControl_To_v1beta1_AccessControl(in, out, s)
}
...
func autoConvert_v1beta1_AuthorizationSource_To_core_AuthorizationSource(in *AuthorizationSource, out *core.AuthorizationSource, s conversion.Scope) error {
...
// Convert_v1beta1_AuthorizationSource_To_core_AuthorizationSource is an autogenerated conversion function.
func Convert_v1beta1_AuthorizationSource_To_core_AuthorizationSource(in *AuthorizationSource, out *core.AuthorizationSource, s conversion.Scope) error {
	return autoConvert_v1beta1_AuthorizationSource_To_core_AuthorizationSource(in, out, s)
}

func autoConvert_core_AuthorizationSource_To_v1beta1_AuthorizationSource(in *core.AuthorizationSource, out *AuthorizationSource, s conversion.Scope) error {
	out.IPBlocks = *(*[]string)(unsafe.Pointer(&in.IPBlocks))
	out.NotIPBlocks = *(*[]string)(unsafe.Pointer(&in.NotIPBlocks))
	out.RemoteIPBlocks = *(*[]string)(unsafe.Pointer(&in.RemoteIPBlocks))
	out.NotRemoteIPBlocks = *(*[]string)(unsafe.Pointer(&in.NotRemoteIPBlocks))
...
// Convert_core_AuthorizationSource_To_v1beta1_AuthorizationSource is an autogenerated conversion function.
func Convert_core_AuthorizationSource_To_v1beta1_AuthorizationSource(in *core.AuthorizationSource, out *AuthorizationSource, s conversion.Scope) error {
	return autoConvert_core_AuthorizationSource_To_v1beta1_AuthorizationSource(in, out, s)
}
