...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Authentication)(nil), (*core.Authentication)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_Authentication_To_core_Authentication(a.(*Authentication), b.(*core.Authentication), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.Authentication)(nil), (*Authentication)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_Authentication_To_v1beta1_Authentication(a.(*core.Authentication), b.(*Authentication), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_Authentication_To_core_Authentication(in *Authentication, out *core.Authentication, s conversion.Scope) error {
	out.Structured = (*core.StructuredAuthentication)(unsafe.Pointer(in.Structured))
	return nil
}

// Convert_v1beta1_Authentication_To_core_Authentication is an autogenerated conversion function.
func Convert_v1beta1_Authentication_To_core_Authentication(in *Authentication, out *core.Authentication, s conversion.Scope) error {
	return autoConvert_v1beta1_Authentication_To_core_Authentication(in, out, s)
}

func autoConvert_core_Authentication_To_v1beta1_Authentication(in *core.Authentication, out *Authentication, s conversion.Scope) error {
	out.Structured = (*StructuredAuthentication)(unsafe.Pointer(in.Structured))
	return nil
}

// Convert_core_Authentication_To_v1beta1_Authentication is an autogenerated conversion function.
func Convert_core_Authentication_To_v1beta1_Authentication(in *core.Authentication, out *Authentication, s conversion.Scope) error {
	return autoConvert_core_Authentication_To_v1beta1_Authentication(in, out, s)
}
...
func autoConvert_v1beta1_KubeAPIServerConfig_To_core_KubeAPIServerConfig(in *KubeAPIServerConfig, out *core.KubeAPIServerConfig, s conversion.Scope) error {
	...
	out.Authentication = (*core.Authentication)(unsafe.Pointer(in.Authentication))
	return nil
}
