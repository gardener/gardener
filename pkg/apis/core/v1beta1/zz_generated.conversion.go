...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ComponentImageVector)(nil), (*core.ComponentImageVector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ComponentImageVector_To_core_ComponentImageVector(a.(*ComponentImageVector), b.(*core.ComponentImageVector), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ComponentImageVector)(nil), (*ComponentImageVector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ComponentImageVector_To_v1beta1_ComponentImageVector(a.(*core.ComponentImageVector), b.(*ComponentImageVector), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*ImageSource)(nil), (*core.ImageSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ImageSource_To_core_ImageSource(a.(*ImageSource), b.(*core.ImageSource), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ImageSource)(nil), (*ImageSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ImageSource_To_v1beta1_ImageSource(a.(*core.ImageSource), b.(*ImageSource), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_ComponentImageVector_To_core_ComponentImageVector(in *ComponentImageVector, out *core.ComponentImageVector, s conversion.Scope) error {
	out.Name = in.Name
	out.ImageVector = *(*core.ImageVector)(unsafe.Pointer(&in.ImageVector))
	return nil
}

// Convert_v1beta1_ComponentImageVector_To_core_ComponentImageVector is an autogenerated conversion function.
func Convert_v1beta1_ComponentImageVector_To_core_ComponentImageVector(in *ComponentImageVector, out *core.ComponentImageVector, s conversion.Scope) error {
	return autoConvert_v1beta1_ComponentImageVector_To_core_ComponentImageVector(in, out, s)
}

func autoConvert_core_ComponentImageVector_To_v1beta1_ComponentImageVector(in *core.ComponentImageVector, out *ComponentImageVector, s conversion.Scope) error {
	out.Name = in.Name
	out.ImageVector = *(*ImageVector)(unsafe.Pointer(&in.ImageVector))
	return nil
}

// Convert_core_ComponentImageVector_To_v1beta1_ComponentImageVector is an autogenerated conversion function.
func Convert_core_ComponentImageVector_To_v1beta1_ComponentImageVector(in *core.ComponentImageVector, out *ComponentImageVector, s conversion.Scope) error {
	return autoConvert_core_ComponentImageVector_To_v1beta1_ComponentImageVector(in, out, s)
}
...
func autoConvert_v1beta1_ImageSource_To_core_ImageSource(in *ImageSource, out *core.ImageSource, s conversion.Scope) error {
	out.Name = in.Name
	out.SourceRepository = (*string)(unsafe.Pointer(in.SourceRepository))
	out.Repository = in.Repository
	out.Tag = (*string)(unsafe.Pointer(in.Tag))
	out.RuntimeVersion = (*string)(unsafe.Pointer(in.RuntimeVersion))
	out.TargetVersion = (*string)(unsafe.Pointer(in.TargetVersion))
	return nil
}

// Convert_v1beta1_ImageSource_To_core_ImageSource is an autogenerated conversion function.
func Convert_v1beta1_ImageSource_To_core_ImageSource(in *ImageSource, out *core.ImageSource, s conversion.Scope) error {
	return autoConvert_v1beta1_ImageSource_To_core_ImageSource(in, out, s)
}

func autoConvert_core_ImageSource_To_v1beta1_ImageSource(in *core.ImageSource, out *ImageSource, s conversion.Scope) error {
	out.Name = in.Name
	out.SourceRepository = (*string)(unsafe.Pointer(in.SourceRepository))
	out.Repository = in.Repository
	out.Tag = (*string)(unsafe.Pointer(in.Tag))
...
// Convert_core_ImageSource_To_v1beta1_ImageSource is an autogenerated conversion function.
func Convert_core_ImageSource_To_v1beta1_ImageSource(in *core.ImageSource, out *ImageSource, s conversion.Scope) error {
	return autoConvert_core_ImageSource_To_v1beta1_ImageSource(in, out, s)
}
