...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Settings)(nil), (*core.Settings)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_Settings_To_core_Settings(a.(*Settings), b.(*core.Settings), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.Settings)(nil), (*Settings)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_Settings_To_v1beta1_Settings(a.(*core.Settings), b.(*Settings), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_Settings_To_core_Settings(in *Settings, out *core.Settings, s conversion.Scope) error {
...
// Convert_v1beta1_Settings_To_core_Settings is an autogenerated conversion function.
func Convert_v1beta1_Settings_To_core_Settings(in *Settings, out *core.Settings, s conversion.Scope) error {
	return autoConvert_v1beta1_Settings_To_core_Settings(in, out, s)
}

func autoConvert_core_Settings_To_v1beta1_Settings(in *core.Settings, out *Settings, s conversion.Scope) error {
	out.MachineDrainTimeout = (*metav1.Duration)(unsafe.Pointer(in.MachineDrainTimeout))
	out.MachineHealthTimeout = (*metav1.Duration)(unsafe.Pointer(in.MachineHealthTimeout))
	out.MachineCreationTimeout = (*metav1.Duration)(unsafe.Pointer(in.MachineCreationTimeout))
	out.MaxEvictRetries = (*int32)(unsafe.Pointer(in.MaxEvictRetries))
...
// Convert_core_Settings_To_v1beta1_Settings is an autogenerated conversion function.
func Convert_core_Settings_To_v1beta1_Settings(in *core.Settings, out *Settings, s conversion.Scope) error {
	return autoConvert_core_Settings_To_v1beta1_Settings(in, out, s)
}
