...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*SeedSettingAdmissionController)(nil), (*core.SeedSettingAdmissionController)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_SeedSettingAdmissionController_To_core_SeedSettingAdmissionController(a.(*SeedSettingAdmissionController), b.(*core.SeedSettingAdmissionController), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.SeedSettingAdmissionController)(nil), (*SeedSettingAdmissionController)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_SeedSettingAdmissionController_To_v1beta1_SeedSettingAdmissionController(a.(*core.SeedSettingAdmissionController), b.(*SeedSettingAdmissionController), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_SeedSettingAdmissionController_To_core_SeedSettingAdmissionController(in *SeedSettingAdmissionController, out *core.SeedSettingAdmissionController, s conversion.Scope) error {
	out.Replicas = in.Replicas
	return nil
}

// Convert_v1beta1_SeedSettingAdmissionController_To_core_SeedSettingAdmissionController is an autogenerated conversion function.
func Convert_v1beta1_SeedSettingAdmissionController_To_core_SeedSettingAdmissionController(in *SeedSettingAdmissionController, out *core.SeedSettingAdmissionController, s conversion.Scope) error {
	return autoConvert_v1beta1_SeedSettingAdmissionController_To_core_SeedSettingAdmissionController(in, out, s)
}

func autoConvert_core_SeedSettingAdmissionController_To_v1beta1_SeedSettingAdmissionController(in *core.SeedSettingAdmissionController, out *SeedSettingAdmissionController, s conversion.Scope) error {
	out.Replicas = in.Replicas
	return nil
}

// Convert_core_SeedSettingAdmissionController_To_v1beta1_SeedSettingAdmissionController is an autogenerated conversion function.
func Convert_core_SeedSettingAdmissionController_To_v1beta1_SeedSettingAdmissionController(in *core.SeedSettingAdmissionController, out *SeedSettingAdmissionController, s conversion.Scope) error {
	return autoConvert_core_SeedSettingAdmissionController_To_v1beta1_SeedSettingAdmissionController(in, out, s)
}
