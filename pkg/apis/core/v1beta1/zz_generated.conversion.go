...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PendingWorkersUpdate)(nil), (*core.PendingWorkersUpdate)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_PendingWorkersUpdate_To_core_PendingWorkersUpdate(a.(*PendingWorkersUpdate), b.(*core.PendingWorkersUpdate), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.PendingWorkersUpdate)(nil), (*PendingWorkersUpdate)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_PendingWorkersUpdate_To_v1beta1_PendingWorkersUpdate(a.(*core.PendingWorkersUpdate), b.(*PendingWorkersUpdate), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_PendingWorkersUpdate_To_core_PendingWorkersUpdate(in *PendingWorkersUpdate, out *core.PendingWorkersUpdate, s conversion.Scope) error {
	out.Name = in.Name
	out.LastInitiationTimeCertificateAuthoritiesRotation = (*metav1.Time)(unsafe.Pointer(in.LastInitiationTimeCertificateAuthoritiesRotation))
	out.LastInitiationTimeServiceAccountKeyRotation = (*metav1.Time)(unsafe.Pointer(in.LastInitiationTimeServiceAccountKeyRotation))
	return nil
}

// Convert_v1beta1_PendingWorkersUpdate_To_core_PendingWorkersUpdate is an autogenerated conversion function.
func Convert_v1beta1_PendingWorkersUpdate_To_core_PendingWorkersUpdate(in *PendingWorkersUpdate, out *core.PendingWorkersUpdate, s conversion.Scope) error {
	return autoConvert_v1beta1_PendingWorkersUpdate_To_core_PendingWorkersUpdate(in, out, s)
}

func autoConvert_core_PendingWorkersUpdate_To_v1beta1_PendingWorkersUpdate(in *core.PendingWorkersUpdate, out *PendingWorkersUpdate, s conversion.Scope) error {
	out.Name = in.Name
	out.LastInitiationTimeCertificateAuthoritiesRotation = (*metav1.Time)(unsafe.Pointer(in.LastInitiationTimeCertificateAuthoritiesRotation))
	out.LastInitiationTimeServiceAccountKeyRotation = (*metav1.Time)(unsafe.Pointer(in.LastInitiationTimeServiceAccountKeyRotation))
	return nil
...
// Convert_core_PendingWorkersUpdate_To_v1beta1_PendingWorkersUpdate is an autogenerated conversion function.
func Convert_core_PendingWorkersUpdate_To_v1beta1_PendingWorkersUpdate(in *core.PendingWorkersUpdate, out *PendingWorkersUpdate, s conversion.Scope) error {
	return autoConvert_core_PendingWorkersUpdate_To_v1beta1_PendingWorkersUpdate(in, out, s)
}
...
func autoConvert_v1beta1_ShootStatus_To_core_ShootStatus(in *ShootStatus, out *core.ShootStatus, s conversion.Scope) error {
	...
	out.PendingWorkersUpdates = *(*[]core.PendingWorkersUpdate)(unsafe.Pointer(&in.PendingWorkersUpdates))
	return nil
}
...
func autoConvert_core_ShootStatus_To_v1beta1_ShootStatus(in *core.ShootStatus, out *ShootStatus, s conversion.Scope) error {
	...
	out.PendingWorkersUpdates = *(*[]PendingWorkersUpdate)(unsafe.Pointer(&in.PendingWorkersUpdates))
	return nil
}
