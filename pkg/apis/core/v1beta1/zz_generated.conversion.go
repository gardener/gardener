...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ResourceRequirements)(nil), (*core.ResourceRequirements)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ResourceRequirements_To_core_ResourceRequirements(a.(*ResourceRequirements), b.(*core.ResourceRequirements), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ResourceRequirements)(nil), (*ResourceRequirements)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ResourceRequirements_To_v1beta1_ResourceRequirements(a.(*core.ResourceRequirements), b.(*ResourceRequirements), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_ResourceRequirements_To_core_ResourceRequirements(in *ResourceRequirements, out *core.ResourceRequirements, s conversion.Scope) error {
	out.Requests = *(*v1.ResourceList)(unsafe.Pointer(&in.Requests))
	return nil
}

// Convert_v1beta1_ResourceRequirements_To_core_ResourceRequirements is an autogenerated conversion function.
func Convert_v1beta1_ResourceRequirements_To_core_ResourceRequirements(in *ResourceRequirements, out *core.ResourceRequirements, s conversion.Scope) error {
	return autoConvert_v1beta1_ResourceRequirements_To_core_ResourceRequirements(in, out, s)
}

func autoConvert_core_ResourceRequirements_To_v1beta1_ResourceRequirements(in *core.ResourceRequirements, out *ResourceRequirements, s conversion.Scope) error {
	out.Requests = *(*v1.ResourceList)(unsafe.Pointer(&in.Requests))
	return nil
}

// Convert_core_ResourceRequirements_To_v1beta1_ResourceRequirements is an autogenerated conversion function.
func Convert_core_ResourceRequirements_To_v1beta1_ResourceRequirements(in *core.ResourceRequirements, out *ResourceRequirements, s conversion.Scope) error {
	return autoConvert_core_ResourceRequirements_To_v1beta1_ResourceRequirements(in, out, s)
}
...
func autoConvert_v1beta1_ShootSpec_To_core_ShootSpec(in *ShootSpec, out *core.ShootSpec, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_ResourceRequirements_To_core_ResourceRequirements(&in.ResourceRequirements, &out.ResourceRequirements, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_core_ShootSpec_To_v1beta1_ShootSpec(in *core.ShootSpec, out *ShootSpec, s conversion.Scope) error {
	...
	if err := Convert_core_ResourceRequirements_To_v1beta1_ResourceRequirements(&in.ResourceRequirements, &out.ResourceRequirements, s); err != nil {
		return err
	}
	return nil
}
