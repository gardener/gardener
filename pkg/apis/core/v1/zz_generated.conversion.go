...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NamedResourceReference)(nil), (*core.NamedResourceReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NamedResourceReference_To_core_NamedResourceReference(a.(*NamedResourceReference), b.(*core.NamedResourceReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.NamedResourceReference)(nil), (*NamedResourceReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_NamedResourceReference_To_v1_NamedResourceReference(a.(*core.NamedResourceReference), b.(*NamedResourceReference), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1_NamedResourceReference_To_core_NamedResourceReference is an autogenerated conversion function.
func Convert_v1_NamedResourceReference_To_core_NamedResourceReference(in *NamedResourceReference, out *core.NamedResourceReference, s conversion.Scope) error {
	return autoConvert_v1_NamedResourceReference_To_core_NamedResourceReference(in, out, s)
}
...
// Convert_core_NamedResourceReference_To_v1_NamedResourceReference is an autogenerated conversion function.
func Convert_core_NamedResourceReference_To_v1_NamedResourceReference(in *core.NamedResourceReference, out *NamedResourceReference, s conversion.Scope) error {
	return autoConvert_core_NamedResourceReference_To_v1_NamedResourceReference(in, out, s)
}
