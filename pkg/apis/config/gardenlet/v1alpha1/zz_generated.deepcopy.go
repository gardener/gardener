...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HealthProbesServer) DeepCopyInto(out *HealthProbesServer) {
	*out = *in
	if in.Enable != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HealthProbesServer.
func (in *HealthProbesServer) DeepCopy() *HealthProbesServer {
	if in == nil {
		return nil
	}
	out := new(HealthProbesServer)
	in.DeepCopyInto(out)
	return out
}
