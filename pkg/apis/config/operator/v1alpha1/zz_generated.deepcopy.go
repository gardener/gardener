...
import (
	gardenletv1alpha1 "github.com/gardener/gardener/pkg/apis/config/gardenlet/v1alpha1"
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtensionReferenceControllerConfiguration) DeepCopyInto(out *ExtensionReferenceControllerConfiguration) {
	*out = *in
	if in.ConcurrentSyncs != nil {
		in, out := &in.ConcurrentSyncs, &out.ConcurrentSyncs
		*out = new(int)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtensionReferenceControllerConfiguration.
func (in *ExtensionReferenceControllerConfiguration) DeepCopy() *ExtensionReferenceControllerConfiguration {
	if in == nil {
		return nil
	}
	out := new(ExtensionReferenceControllerConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GardenControllerConfig) DeepCopyInto(out *GardenControllerConfig) {
	*out = *in
	...
	if in.ETCDConfig != nil {
		...
		*out = new(gardenletv1alpha1.ETCDConfig)
		(*in).DeepCopyInto(*out)
	}
	return
}
