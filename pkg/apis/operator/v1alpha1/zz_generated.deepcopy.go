...
func (in *CertManagement) DeepCopyInto(out *CertManagement) {
	*out = *in
	if in.Deployment != nil {
		...
		*out = new(CertManagementDeployment)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertManagementDeployment) DeepCopyInto(out *CertManagementDeployment) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertManagementDeployment.
func (in *CertManagementDeployment) DeepCopy() *CertManagementDeployment {
	if in == nil {
		return nil
	}
	out := new(CertManagementDeployment)
