...
func (in *CertManagement) DeepCopyInto(out *CertManagement) {
	*out = *in
	...
	in.DefaultIssuer.DeepCopyInto(&out.DefaultIssuer)
	return
}
...
func (in *CertManagementConfig) DeepCopyInto(out *CertManagementConfig) {
	*out = *in
	if in.CACertificatesSecretRef != nil {
		in, out := &in.CACertificatesSecretRef, &out.CACertificatesSecretRef
		*out = new(v1.LocalObjectReference)
		**out = **in
	}
	return
