...
const (
	...
	// HighAvailabilityConfigZonePinning is a constant for an annotation on a Namespace which explicitly enables or
	// disables pinning of workload to the specified zones.
