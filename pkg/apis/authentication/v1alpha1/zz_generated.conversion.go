...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*Credentials)(nil), (*authentication.Credentials)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Credentials_To_authentication_Credentials(a.(*Credentials), b.(*authentication.Credentials), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*authentication.Credentials)(nil), (*Credentials)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_authentication_Credentials_To_v1alpha1_Credentials(a.(*authentication.Credentials), b.(*Credentials), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*WorkloadIdentityReference)(nil), (*authentication.WorkloadIdentityReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_WorkloadIdentityReference_To_authentication_WorkloadIdentityReference(a.(*WorkloadIdentityReference), b.(*authentication.WorkloadIdentityReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*authentication.WorkloadIdentityReference)(nil), (*WorkloadIdentityReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_authentication_WorkloadIdentityReference_To_v1alpha1_WorkloadIdentityReference(a.(*authentication.WorkloadIdentityReference), b.(*WorkloadIdentityReference), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_Credentials_To_authentication_Credentials is an autogenerated conversion function.
func Convert_v1alpha1_Credentials_To_authentication_Credentials(in *Credentials, out *authentication.Credentials, s conversion.Scope) error {
	return autoConvert_v1alpha1_Credentials_To_authentication_Credentials(in, out, s)
}
...
// Convert_authentication_Credentials_To_v1alpha1_Credentials is an autogenerated conversion function.
func Convert_authentication_Credentials_To_v1alpha1_Credentials(in *authentication.Credentials, out *Credentials, s conversion.Scope) error {
	return autoConvert_authentication_Credentials_To_v1alpha1_Credentials(in, out, s)
}
...
func autoConvert_v1alpha1_WorkloadIdentityReference_To_authentication_WorkloadIdentityReference(in *WorkloadIdentityReference, out *authentication.WorkloadIdentityReference, s conversion.Scope) error {
	out.Name = in.Name
	out.Namespace = in.Namespace
	return nil
}

// Convert_v1alpha1_WorkloadIdentityReference_To_authentication_WorkloadIdentityReference is an autogenerated conversion function.
func Convert_v1alpha1_WorkloadIdentityReference_To_authentication_WorkloadIdentityReference(in *WorkloadIdentityReference, out *authentication.WorkloadIdentityReference, s conversion.Scope) error {
	return autoConvert_v1alpha1_WorkloadIdentityReference_To_authentication_WorkloadIdentityReference(in, out, s)
}

func autoConvert_authentication_WorkloadIdentityReference_To_v1alpha1_WorkloadIdentityReference(in *authentication.WorkloadIdentityReference, out *WorkloadIdentityReference, s conversion.Scope) error {
	out.Name = in.Name
	out.Namespace = in.Namespace
	return nil
}

// Convert_authentication_WorkloadIdentityReference_To_v1alpha1_WorkloadIdentityReference is an autogenerated conversion function.
func Convert_authentication_WorkloadIdentityReference_To_v1alpha1_WorkloadIdentityReference(in *authentication.WorkloadIdentityReference, out *WorkloadIdentityReference, s conversion.Scope) error {
	return autoConvert_authentication_WorkloadIdentityReference_To_v1alpha1_WorkloadIdentityReference(in, out, s)
}
