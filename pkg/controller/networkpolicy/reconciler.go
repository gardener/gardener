		...
		policy.Spec = networkingv1.NetworkPolicySpec{
			...
			Egress: []networkingv1.NetworkPolicyEgressRule{{
				...
				Ports: []networkingv1.NetworkPolicyPort{
					{Protocol: ptr.To(corev1.ProtocolUDP), Port: new(intstr.FromInt32(corednsconstants.PortServiceServer))},
					{Protocol: ptr.To(corev1.ProtocolTCP), Port: new(intstr.FromInt32(corednsconstants.PortServiceServer))},
					{Protocol: ptr.To(corev1.ProtocolUDP), Port: new(intstr.FromInt32(corednsconstants.PortServer))},
					{Protocol: ptr.To(corev1.ProtocolTCP), Port: new(intstr.FromInt32(corednsconstants.PortServer))},
				},
			}},
			Ingress:     []networkingv1.NetworkPolicyIngressRule{},
			PolicyTypes: []networkingv1.PolicyType{networkingv1.PolicyTypeEgress},
