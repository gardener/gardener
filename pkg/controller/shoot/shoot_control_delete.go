...
func (c *defaultControl) deleteShoot(o *operation.Operation) *gardenv1beta1.LastError {
	...
	var (
		...
		deleteKubeAPIServer               = f.AddTask(botanist.DeleteKubeAPIServer, defaultRetry, syncPointCleanup)
		...
		syncPointTerraformers             = f.AddSyncPoint(deleteSeedMonitoring, deleteKubeAPIServer, destroyNginxIngressResources, destroyKube2IAMResources, destroyInfrastructure, destroyExternalDomainDNSRecord, destroyBackupInfrastructure, destroyInternalDomainDNSRecord)
