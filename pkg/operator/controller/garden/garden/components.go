		...
		AdditionalAlertRelabelConfigs: []monitoringv1.RelabelConfig{
			{
				...
				Regex:        "(.+);(.+)",
				Action:       "replace",
				Replacement:  ptr.To("https://dashboard." + strings.TrimPrefix(ingressDomain, "ingress.") + "/namespace/garden-$1/shoots/$2"),
			...
			},
			{
				...
				Regex:        "garden;(.+)",
				Action:       "replace",
				Replacement:  ptr.To("https://dashboard." + strings.TrimPrefix(ingressDomain, "ingress.") + "/namespace/garden/shoots/$1"),
				TargetLabel:  "shoot_dashboard_url",
			},
		},
