...
var _ = Describe("Add", func() {
	Describe("#MapManagedResourceToExtension", func() {
		...
		DescribeTable("map a managed resource to an extension",
			...
			Entry("managed resource for extension in non-garden namespace", "goo", "garden-extension-foobar-12345", ""),
			Entry("managed resource for extension", "garden", "garden-extension-foobar-12345", "foobar"),
