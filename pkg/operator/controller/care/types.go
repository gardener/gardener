...
type NewHealthCheckFunc func(*operatorv1alpha1.Garden, client.Client, clock.Clock, string) HealthCheck

// defaultNewHealthCheck is the default function to create a new instance for performing health checks.
var defaultNewHealthCheck NewHealthCheckFunc = func(garden *operatorv1alpha1.Garden, client client.Client, clock clock.Clock, gardenNamespace string) HealthCheck {
	return care.NewHealthForGarden(garden, client, clock, gardenNamespace)
}
