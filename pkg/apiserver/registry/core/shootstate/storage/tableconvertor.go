...
func newTableConvertor() rest.TableConvertor {
	return &convertor{
		headers: []metav1beta1.TableColumnDefinition{
			...
			{Name: "Gardener Data", Type: "string", Description: swaggerMetadataDescriptions["gardenerData"]},
			{Name: "Extension States", Type: "string", Description: swaggerMetadataDescriptions["extensionStates"]},
...
func (c *convertor) ConvertToTable(_ context.Context, o runtime.Object, _ runtime.Object) (*metav1beta1.Table, error) {
	...
	table.Rows, err = metatable.MetaToTableRow(o, func(o runtime.Object, _ metav1.Object, _, _ string) ([]any, error) {
		...
		cells = append(cells, len(obj.Spec.Gardener))
		cells = append(cells, len(obj.Spec.Extensions))
