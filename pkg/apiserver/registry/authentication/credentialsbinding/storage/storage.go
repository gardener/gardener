...
import (
	...
	"github.com/gardener/gardener/pkg/apiserver/registry/authentication/credentialsbinding"
)
...
func NewREST(optsGetter generic.RESTOptionsGetter) *REST {
	store := &genericregistry.Store{
		NewFunc:     func() runtime.Object { return &authentication.CredentialsBinding{} },
		NewListFunc: func() runtime.Object { return &authentication.CredentialsBindingList{} },

		DefaultQualifiedResource:  authentication.Resource("credentialsbindings"),
		SingularQualifiedResource: authentication.Resource("credentialsbinding"),
