...
func (in *Etcd) DeepCopyInto(out *Etcd) {
	*out = *in
	if in.EtcdCABundle != nil {
		in, out := &in.EtcdCABundle, &out.EtcdCABundle
		*out = new(string)
		**out = **in
	}
	if in.EtcdClientCert != nil {
		in, out := &in.EtcdClientCert, &out.EtcdClientCert
		*out = new(string)
		**out = **in
	}
	if in.EtcdClientKey != nil {
		in, out := &in.EtcdClientKey, &out.EtcdClientKey
		*out = new(string)
		**out = **in
	}
...
func (in *Imports) DeepCopyInto(out *Imports) {
	*out = *in
	...
	if in.VirtualGardenCluster != nil {
		in, out := &in.VirtualGardenCluster, &out.VirtualGardenCluster
		*out = new(corev1alpha1.Target)
		(*in).DeepCopyInto(*out)
	}
