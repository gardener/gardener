...
var _ = Describe("Gardenlet Landscaper reconciliation testing", func() {
	...
	Describe("#Reconcile", func() {
		...
		It("should successfully reconcile", func() {
			...
			appliercommon.ValidateGardenletChartRBAC(ctx, fakeGardenletChartClient, expectedLabels, "gardenlet")

			appliercommon.ValidateGardenletChartServiceAccount(ctx, fakeGardenletChartClient, false, expectedLabels, "gardenlet")

			expectedGardenletConfig := appliercommon.ComputeExpectedGardenletConfiguration(false, false, false, landscaper.gardenletConfiguration.GardenClientConnection.BootstrapKubeconfig, landscaper.gardenletConfiguration.GardenClientConnection.KubeconfigSecret, landscaper.gardenletConfiguration.SeedConfig)
			...
			expectedGardenletDeploymentSpec := appliercommon.ComputeExpectedGardenletDeploymentSpec(&importsv1alpha1.GardenletDeploymentConfiguration{}, false, nil, nil, expectedLabels)
			appliercommon.VerifyGardenletDeployment(ctx, fakeGardenletChartClient, expectedGardenletDeploymentSpec, &importsv1alpha1.GardenletDeploymentConfiguration{}, false, false, false, false, expectedLabels)
		})
	})
