...
//go:generate cp 10-crd-operator.gardener.cloud_gardens.yaml ../../charts/gardener/operator/files/crd-gardens.yaml
//go:generate cp 10-crd-operator.gardener.cloud_extensions.yaml ../../charts/gardener/operator/files/crd-extensions.yaml
