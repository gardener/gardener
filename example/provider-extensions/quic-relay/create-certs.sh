...
kubectl rollout restart deployment -n relay gardener-api-quic-server --kubeconfig $seed_kubeconfig
...
kubectl rollout restart deployment -n relay gardener-api-quic-client --kubeconfig $garden_kubeconfig
