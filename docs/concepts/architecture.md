...
* Wait for the "shoot" cluster API server to become responsive (pods will be scheduled and persistent volumes are created by Kubernetes via the respective cloud provider)
