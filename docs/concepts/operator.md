...
This works similar like for `Shoot`s (see [Highly Available Shoot Control Plane](../usage/shoot_high_availability.md)) except for the fact that there is no failure tolerance type configurability.
