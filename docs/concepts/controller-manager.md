...
The name of the namespace can either be specified explicitly in the `.spec.namespace` (must be prefixed with `garden-`), or it will be auto-generated by the controller.
