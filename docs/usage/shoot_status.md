...
- `ERR_INFRA_UNAUTHENTICATED` - indicates that the last error occurred due to client request not being completed because it lacks valid authentication credentials for the requested resource. It is classified as a non-retryable error code.
