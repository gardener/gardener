...
|------|-----------------------|--------------------|----------------------------------------------------------------------------|
| IPv4 | 192.168.123.0/24      | Default VPN Range  | Used for communication between seed API server and shoot resources via VPN |
| IPv6 | fd8f:6d53:b97a:1::/96 | Default VPN Range  |                                                                            |
| IPv4 | 240.0.0.0/8           | Seed Service Range | Used for the `kubernetes.default.svc.cluster.local` service in a shoot     |
