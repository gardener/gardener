...
* Also, if your seed is configured to host HA shoot control planes, then `gardenlet` will by default be deployed with multiple replicas across nodes or availability zones.
