...
The `gardener-operator` runs a [`NetworkPolicy` controller](../concepts/gardenlet.md#networkpolicy-controller) which is responsible for the following namespaces:
