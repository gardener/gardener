...
These extensions often serve a well-defined purpose, e.g. the management of [DNS records](dnsrecord.md), [infrastructure](./extension-resources/infrastructure.md), etc.
