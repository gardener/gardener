...
| WorkerPoolHashWithNodeAgentSecret  | `false` | `Alpha` | `1.97` |        |
...
| WorkerPoolHashWithNodeAgentSecret | `gardenlet`                       | Enables usage of the new worker pool hash calculation. All provider extensions must be upgraded to support this feature first.                                                                                                                                                                                                                                                                                                                                                                                                                                      |
