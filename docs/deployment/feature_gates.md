...
| DisableNginxIngressInGarden    | `false` | `Alpha` | `1.141` |         |
| DisableNginxIngressInSeed      | `false` | `Alpha` | `1.141` |         |
...
| UseUnifiedHTTPProxyPort        | `gardenlet`                                                      | Enables the API server proxy and shoot VPN client to connect to the unified port using the new X-Gardener-Destination header.                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| DisableNginxIngressInShoot     | `gardener-apiserver`, `gardener-controller-manager`, `gardenlet` | Disables the creation/enablement of the deployment nginx ingress shoot addon and removes the nginx ingress controller (if existing) from the Shoot clusters.                                                                                                                                                                                                                                                                                                                                                                                             |
