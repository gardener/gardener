...
| DeployVictoriaLogs             | `false` | `Alpha` | `1.124` |         |
...
| DeployVictoriaLogs            | `gardenlet`, `gardener-operator` | Enables the deployment of `VictoriaLogs` instance in the control-plane of `Shoots` and `garden` namespace of `Seed` and `Garden` clusters. `VictoriaLogs` will be used as the log aggregation system instead of `Vali`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| VersionClassificationLifecycle | `gardener-apiserver`             | Enables the features introduced by GEP-0032, including lifecycle-based classification for Kubernetes and machine image versions.                                                                                                                                                                                                                                                                                                                                                                                                                         |
