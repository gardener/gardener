...
| CloudProfileVersionClassificationLifecycles | `false` | `Alpha` | `1.133` |         |
...
| CloudProfileVersionClassificationLifecycles | `gardener-apiserver`               | Enables the features introduced by GEP-32, including lifecycle-based classification for Kubernetes and machine image versions.                                                                                                                                                                                                                                                                                                                                                                                                                         |
