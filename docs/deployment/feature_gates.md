...
| IPv6SingleStack                            | `gardener-apiserver`, `gardenlet` | Allows creating shoot clusters with [IPv6 single-stack networking](../usage/ipv6.md) ([GEP-21](../proposals/21-ipv6-singlestack-local.md)).                                                                                                                                                                                                                                                                                                                                                                      |
