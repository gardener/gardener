...
| MutableShootSpecNetworkingNodes            | `gardener-apiserver`             | Allows updating the field `spec.networking.nodes` `. The validity of the values has to be checked in the infrastructure extensions.                                                                                                                                                                                                                                                                                                                                                  |
