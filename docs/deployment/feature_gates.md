...
| WorkerPoolHashWithNodeAgentSecret  | `false` | `Alpha` | `1.96` |        |
...
| WorkerPoolHashWithNodeAgentSecret | `gardenlet`                       | Enables usage of the new worker pool hash calculation. All provider extension must be upgraded to support this feature first.enablement.                                                                                                                                                                                                                                                                                                                                                                                                                            |
