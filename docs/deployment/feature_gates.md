...
| VpaInPlaceOrRecreateUpdateMode           | `false` | `Alpha` | `1.128` |         |
...
| VpaInPlaceOrRecreateUpdateMode           | `gardenlet`, `gardener-operator`   | Enables the usage of in-place Pod resource updates in `Shoot`, `Seed` and `Garden` cluster's Vertical Pod Autoscaler deployments.                                                                                                                                                                                                                                                                                                                                                                                                                        |
