...
| VersionClassificationLifecycle | `gardener-apiserver`, `gardener-controller-manager` | Enables the features introduced by GEP-32, including lifecycle-based classification for Kubernetes and machine image versions.                                                                                                                                                                                                                                                                                                                                                                                                                           |
