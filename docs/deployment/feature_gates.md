...
| LiveControlPlaneMigration      | `gardener-apiserver`                                | Enables setting the `gardener.cloud/operation=live-migrate` annotation on Shoot to trigger live control-plane migration, as described in GEP-0039.                                                                                                                                                                                                                                                                                                                                                                                                       |
