...
<p>
<p>CloudProfileMachineControllerManagerSettings contains a subset of the MachineControllerManagerSettings with configurations for a machine type, e.g., MachineCreationTimeout.</p>
</p>
<table>
<thead>
<tr>
...
<td>
<em>(Optional)</em>
<p>MachineControllerManagerSettings contains a subset of the MachineControllerManagerSettings with configurations for a machine type, e.g., MachineCreationTimeout.</p>
</td>
</tr>
</tbody>
</table>
