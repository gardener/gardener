...
<td>
<em>(Optional)</em>
<p>EncryptedResources is the list of resources which are currently encrypted in the virtual garden by the virtual kube-apiserver.<br />Resources which are encrypted by default will not appear here.<br />See https://github.com/gardener/gardener/blob/master/docs/concepts/operator.md#etcd-encryption-config for more details.<br />Deprecated: This field is deprecated and will be removed with release v1.138.<br />This field will be removed in favor of `status.credentials.encryptionAtRest.resources`.</p>
</td>
</tr>
