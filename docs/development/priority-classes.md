...
| `gardener-system-600`              | 999998600 | `aggregate-prometheus`, `alertmanager`, `fluent-operator`, `fluent-bit`, `plutono`, `kube-state-metrics`, `nginx-ingress-controller`, `nginx-k8s-backend`, `prometheus-operator`, `prometheus-cache`, `vali`,  `seed-prometheus` |
