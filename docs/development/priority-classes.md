...
| `gardener-system-100` | 999998100 | `alertmanager-shoot`, `plutono`, `kube-state-metrics`, `prometheus-shoot`, `blackbox-exporter`, `vali`, `event-logger`, `victoria-logs`, `ext-authz-server`                            |
