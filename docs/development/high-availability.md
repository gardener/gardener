...
The `Shoot` specification allows configuring "high availability" as well as the failure tolerance type for the control plane components, see [Highly Available Shoot Control Plane](../usage/shoot_settings/shoot_high_availability.md) for details.
