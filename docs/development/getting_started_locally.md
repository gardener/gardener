...
> Note that this setup is not supported in combination with `IPFAMILY=ipv6` because of a bug in kind (ref [kubernetes-sigs/kind#3114](https://github.com/kubernetes-sigs/kind/issues/3114)).
