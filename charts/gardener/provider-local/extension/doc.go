...
//go:generate ../../../../hack/generate-controller-registration.sh provider-local . '' ../../../../example/provider-local/base/controller-registration.yaml DNSProvider:local DNSRecord:local ControlPlane:local Infrastructure:local Network:local OperatingSystemConfig:local Worker:local
